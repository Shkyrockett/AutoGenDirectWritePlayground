// <copyright file="ID2D1DeviceContext6.cs" company="Shkyrockett" >
...
namespace Windows.Win32
{
    namespace Graphics.Direct2D
    {
        ...
        /// <seealso cref="Windows.Win32.Graphics.Direct2D.ID2D1RenderTarget" />
        /// <seealso cref="Windows.Win32.Graphics.Direct2D.ID2D1DeviceContext" />
        /// <seealso cref="Windows.Win32.Graphics.Direct2D.ID2D1DeviceContext1" />
        /// <seealso cref="Windows.Win32.Graphics.Direct2D.ID2D1DeviceContext2" />
        /// <seealso cref="Windows.Win32.Graphics.Direct2D.ID2D1DeviceContext3" />
        /// <seealso cref="Windows.Win32.Graphics.Direct2D.ID2D1DeviceContext4" />
        /// <seealso cref="Windows.Win32.Graphics.Direct2D.ID2D1DeviceContext5" />
        [Guid("985F7E37-4ED0-4A19-98A3-15B0EDFDE306"), InterfaceType(ComInterfaceType.InterfaceIsIUnknown), ComImport()]
        [SupportedOSPlatform("windows10.0.10240")]
        public interface ID2D1DeviceContext6
            : ID2D1Resource, ID2D1RenderTarget, ID2D1DeviceContext, ID2D1DeviceContext1, ID2D1DeviceContext2, ID2D1DeviceContext3, ID2D1DeviceContext4, ID2D1DeviceContext5
        {
            ...
            /// </remarks>
            [PreserveSig]
            new HRESULT GetSize(out D2D_SIZE_F size);
            ...
            /// </remarks>
            [PreserveSig]
            new HRESULT GetPixelSize(out D2D_SIZE_U pixelSize);
            ...
            /// <para>
            ///   <see href="https://learn.microsoft.com/windows/win32/api/d2d1_1/nf-d2d1_1-id2d1devicecontext-createbitmap(d2d1_size_u_constvoid_uint32_constd2d1_bitmap_properties1_id2d1bitmap1)#parameters">Read more on docs.microsoft.com</see>.</para></param>
            /// <param name="sourceData"><para>Type: <b>const void*</b> The initial data that will be loaded into the bitmap.</para>
            /// <para>
            ///   <see href="https://learn.microsoft.com/windows/win32/api/d2d1_1/nf-d2d1_1-id2d1devicecontext-createbitmap(d2d1_size_u_constvoid_uint32_constd2d1_bitmap_properties1_id2d1bitmap1)#parameters">Read more on docs.microsoft.com</see>.</para></param>
            /// <param name="pitch"><para>Type: <b>UINT32</b> The pitch of the source data, if specified.</para>
            /// <para>
            ...
            /// </summary>
            /// <param name="space"><para>Type: <b><a href="https://learn.microsoft.com/windows/desktop/api/d2d1_1/ne-d2d1_1-d2d1_color_space">D2D1_COLOR_SPACE</a></b> The space  of color context to create.</para>
            /// <para>
            ///   <see href="https://learn.microsoft.com/windows/win32/api/d2d1_1/nf-d2d1_1-id2d1devicecontext-createcolorcontext#parameters">Read more on learn.microsoft.com</see>.</para></param>
            /// <param name="profile"><para>Type: <b>const BYTE*</b> A buffer containing the ICC profile bytes used to initialize the color context when <i>space</i> is <a href="https://learn.microsoft.com/windows/desktop/api/d2d1_1/ne-d2d1_1-d2d1_color_space">D2D1_COLOR_SPACE_CUSTOM</a>.  For other types, the parameter is ignored and should be set to <b>NULL</b>.</para>
            /// <para>
            ///   <see href="https://learn.microsoft.com/windows/win32/api/d2d1_1/nf-d2d1_1-id2d1devicecontext-createcolorcontext#parameters">Read more on learn.microsoft.com</see>.</para></param>
            /// <param name="profileSize"><para>Type: <b>UINT32</b> The size in bytes of <i>Profile</i>.</para>
            /// <para>
            ///   <see href="https://learn.microsoft.com/windows/win32/api/d2d1_1/nf-d2d1_1-id2d1devicecontext-createcolorcontext#parameters">Read more on learn.microsoft.com</see>.</para></param>
            /// <param name="colorContext"><para>Type: <b><a href="https://learn.microsoft.com/windows/desktop/api/d2d1_1/nn-d2d1_1-id2d1colorcontext">ID2D1ColorContext</a>**</b> When this method returns, contains the address of a pointer to a new color context object.</para>
            /// <para>
            ///   <see href="https://learn.microsoft.com/windows/win32/api/d2d1_1/nf-d2d1_1-id2d1devicecontext-createcolorcontext#parameters">Read more on learn.microsoft.com</see>.</para></param>
            /// <returns>
            /// <para>Type: <b>HRESULT</b> The method returns an <b>HRESULT</b>. Possible values include, but are not limited to, those in the following table. </para>
            ...
            /// </returns>
            /// <remarks>
            ///   <see href="https://learn.microsoft.com/windows/win32/api/d2d1_1/nf-d2d1_1-id2d1devicecontext-createcolorcontext">Learn more about this API from learn.microsoft.com</see>.
            /// </remarks>
            new void CreateColorContext(D2D1_COLOR_SPACE space, [MarshalAs(UnmanagedType.LPArray, SizeParamIndex = 2)] byte[] profile, uint profileSize, out ID2D1ColorContext colorContext);
            ...
            /// </summary>
            /// <param name="filename"><para>Type: <b>PCWSTR</b> The path to the file containing the profile bytes to initialize the color context with.</para>
            /// <para>
            ///   <see href="https://learn.microsoft.com/windows/win32/api/d2d1_1/nf-d2d1_1-id2d1devicecontext-createcolorcontextfromfilename#parameters">Read more on learn.microsoft.com</see>.</para></param>
            /// <param name="colorContext"><para>Type: <b><a href="https://learn.microsoft.com/windows/desktop/api/d2d1_1/nn-d2d1_1-id2d1colorcontext">ID2D1ColorContext</a>**</b> When this method returns, contains the address of a pointer to a new color context.</para>
            /// <para>
            ///   <see href="https://learn.microsoft.com/windows/win32/api/d2d1_1/nf-d2d1_1-id2d1devicecontext-createcolorcontextfromfilename#parameters">Read more on learn.microsoft.com</see>.</para></param>
            /// <returns>
            /// <para>Type: <b>HRESULT</b> The method returns an <b>HRESULT</b>. Possible values include, but are not limited to, those in the following table. </para>
            ...
            /// </returns>
            /// <remarks>
            ///   <see href="https://learn.microsoft.com/windows/win32/api/d2d1_1/nf-d2d1_1-id2d1devicecontext-createcolorcontextfromfilename">Learn more about this API from learn.microsoft.com</see>.
            /// </remarks>
            ...
            /// </summary>
            /// <param name="wicColorContext"><para>Type: <b><a href="https://learn.microsoft.com/windows/desktop/api/wincodec/nn-wincodec-iwiccolorcontext">IWICColorContext</a>*</b> The <a href="https://learn.microsoft.com/windows/desktop/api/wincodec/nn-wincodec-iwiccolorcontext">IWICColorContext</a> used to initialize the color context.</para>
            /// <para>
            ///   <see href="https://learn.microsoft.com/windows/win32/api/d2d1_1/nf-d2d1_1-id2d1devicecontext-createcolorcontextfromwiccolorcontext#parameters">Read more on learn.microsoft.com</see>.</para></param>
            /// <param name="colorContext"><para>Type: <b><a href="https://learn.microsoft.com/windows/desktop/api/d2d1_1/nn-d2d1_1-id2d1colorcontext">ID2D1ColorContext</a>**</b> When this method returns, contains the address of a pointer to a new color context.</para>
            /// <para>
            ///   <see href="https://learn.microsoft.com/windows/win32/api/d2d1_1/nf-d2d1_1-id2d1devicecontext-createcolorcontextfromwiccolorcontext#parameters">Read more on learn.microsoft.com</see>.</para></param>
            /// <returns>
            ...
            /// </returns>
            /// <remarks>
            ///   <see href="https://learn.microsoft.com/windows/win32/api/d2d1_1/nf-d2d1_1-id2d1devicecontext-createcolorcontextfromwiccolorcontext">Learn more about this API from learn.microsoft.com</see>.
            /// </remarks>
            ...
            /// </summary>
            /// <param name="surface"><para>Type: <b><a href="https://learn.microsoft.com/windows/desktop/api/dxgi/nn-dxgi-idxgisurface">IDXGISurface</a>*</b> The DXGI surface from which the bitmap can be created. <div class="alert"><b>Note</b>  The DXGI surface must have been created from the same Direct3D device that the Direct2D device context is associated with. </div><div> </div></para>
            /// <para>
            ///   <see href="https://learn.microsoft.com/windows/win32/api/d2d1_1/nf-d2d1_1-id2d1devicecontext-createbitmapfromdxgisurface(idxgisurface_constd2d1_bitmap_properties1__id2d1bitmap1)#parameters">Read more on docs.microsoft.com</see>.</para></param>
            /// <param name="bitmapProperties"><para>Type: <b>const <a href="https://learn.microsoft.com/windows/desktop/api/d2d1_1/ns-d2d1_1-d2d1_bitmap_properties1">D2D1_BITMAP_PROPERTIES1</a>*</b> The bitmap properties specified in addition to the surface.</para>
            /// <para>
            ///   <see href="https://learn.microsoft.com/windows/win32/api/d2d1_1/nf-d2d1_1-id2d1devicecontext-createbitmapfromdxgisurface(idxgisurface_constd2d1_bitmap_properties1__id2d1bitmap1)#parameters">Read more on docs.microsoft.com</see>.</para></param>
            /// <param name="bitmap"><para>Type: <b><a href="https://learn.microsoft.com/windows/desktop/api/d2d1_1/nn-d2d1_1-id2d1bitmap1">ID2D1Bitmap1</a>**</b> When this method returns, contains the address of a pointer to a new bitmap object.</para>
            /// <para>
            ...
            /// <para>This doc was truncated.</para>
            /// <para>
            ///   <see href="https://learn.microsoft.com/windows/win32/api/d2d1_1/nf-d2d1_1-id2d1devicecontext-createbitmapfromdxgisurface(idxgisurface_constd2d1_bitmap_properties1__id2d1bitmap1)#">Read more on docs.microsoft.com</see>.</para>
            /// </remarks>
            new void CreateBitmapFromDxgiSurface(IDXGISurface surface, in D2D1_BITMAP_PROPERTIES1 bitmapProperties, out ID2D1Bitmap1 bitmap);

            /// <summary>
            /// Creates an effect for the specified class ID.
            /// </summary>
            /// <param name="effectId"><para>Type: <b>REFCLSID</b> The class ID of the effect to create. See <a href="https://learn.microsoft.com/windows/desktop/Direct2D/built-in-effects">Built-in Effects</a> for a list of effect IDs.</para>
            /// <para>
            ///   <see href="https://learn.microsoft.com/windows/win32/api/d2d1_1/nf-d2d1_1-id2d1devicecontext-createeffect#parameters">Read more on learn.microsoft.com</see>.</para></param>
            /// <param name="effect"><para>Type: <b><a href="https://learn.microsoft.com/windows/desktop/api/d2d1_1/nn-d2d1_1-id2d1effect">ID2D1Effect</a>**</b> When this method returns, contains the address of a pointer to a new effect.</para>
            /// <para>
            ///   <see href="https://learn.microsoft.com/windows/win32/api/d2d1_1/nf-d2d1_1-id2d1devicecontext-createeffect#parameters">Read more on learn.microsoft.com</see>.</para></param>
            /// <returns>
            /// <para>Type: <b>HRESULT</b> The method returns an <b>HRESULT</b>. Possible values include, but are not limited to, those in the following table.</para>
            ...
            /// </returns>
            /// <remarks>
            ///   <see href="https://learn.microsoft.com/windows/win32/api/d2d1_1/nf-d2d1_1-id2d1devicecontext-createeffect">Learn more about this API from learn.microsoft.com</see>.
            /// </remarks>
            ...
            /// Creates a gradient stop collection, enabling the gradient to contain color channels with values outside of [0,1] and also enabling rendering to a high-color render target with interpolation in sRGB space.
            /// </summary>
            /// <param name="straightAlphaGradientStops"><para>Type: <b>const <a href="https://learn.microsoft.com/windows/desktop/api/d2d1/ns-d2d1-d2d1_gradient_stop">D2D1_GRADIENT_STOP</a>*</b> An array of color values and offsets.</para>
            /// <para>
            ///   <see href="https://learn.microsoft.com/windows/win32/api/d2d1_1/nf-d2d1_1-id2d1devicecontext-creategradientstopcollection#parameters">Read more on learn.microsoft.com</see>.</para></param>
            /// <param name="straightAlphaGradientStopsCount"><para>Type: <b>UINT</b> The number of elements in the <i>gradientStops</i> array.</para>
            /// <para>
            ///   <see href="https://learn.microsoft.com/windows/win32/api/d2d1_1/nf-d2d1_1-id2d1devicecontext-creategradientstopcollection#parameters">Read more on learn.microsoft.com</see>.</para></param>
            /// <param name="preInterpolationSpace"><para>Type: <b><a href="https://learn.microsoft.com/windows/desktop/api/d2d1_1/ne-d2d1_1-d2d1_color_space">D2D1_COLOR_SPACE</a></b> Specifies both the input color space and the space in which the color interpolation occurs.</para>
            /// <para>
            ///   <see href="https://learn.microsoft.com/windows/win32/api/d2d1_1/nf-d2d1_1-id2d1devicecontext-creategradientstopcollection#parameters">Read more on learn.microsoft.com</see>.</para></param>
            /// <param name="postInterpolationSpace"><para>Type: <b><a href="https://learn.microsoft.com/windows/desktop/api/d2d1_1/ne-d2d1_1-d2d1_color_space">D2D1_COLOR_SPACE</a></b> The color space that colors will be converted to after interpolation occurs.</para>
            /// <para>
            ///   <see href="https://learn.microsoft.com/windows/win32/api/d2d1_1/nf-d2d1_1-id2d1devicecontext-creategradientstopcollection#parameters">Read more on learn.microsoft.com</see>.</para></param>
            /// <param name="bufferPrecision"><para>Type: <b><a href="https://learn.microsoft.com/windows/desktop/api/d2d1_1/ne-d2d1_1-d2d1_buffer_precision">D2D1_BUFFER_PRECISION</a></b> The precision of the texture used to hold interpolated values. <div class="alert"><b>Note</b>  This method will fail if the underlying Direct3D device does not support the requested buffer precision.  Use <a href="https://learn.microsoft.com/windows/desktop/api/d2d1_1/nf-d2d1_1-id2d1devicecontext-isbufferprecisionsupported">ID2D1DeviceContext::IsBufferPrecisionSupported</a> to determine what is supported. </div><div> </div></para>
            /// <para>
            ///   <see href="https://learn.microsoft.com/windows/win32/api/d2d1_1/nf-d2d1_1-id2d1devicecontext-creategradientstopcollection#parameters">Read more on learn.microsoft.com</see>.</para></param>
            /// <param name="extendMode"><para>Type: <b><a href="https://learn.microsoft.com/windows/desktop/api/d2d1/ne-d2d1-d2d1_extend_mode">D2D1_EXTEND_MODE</a></b> Defines how colors outside of the range defined by the stop collection are determined.</para>
            /// <para>
            ///   <see href="https://learn.microsoft.com/windows/win32/api/d2d1_1/nf-d2d1_1-id2d1devicecontext-creategradientstopcollection#parameters">Read more on learn.microsoft.com</see>.</para></param>
            /// <param name="colorInterpolationMode"><para>Type: <b><a href="https://learn.microsoft.com/windows/desktop/api/d2d1_1/ne-d2d1_1-d2d1_color_interpolation_mode">D2D1_COLOR_INTERPOLATION_MODE</a></b> Defines how colors are interpolated.  D2D1_COLOR_INTERPOLATION_MODE_PREMULTIPLIED is the default, see Remarks for more info.</para>
            /// <para>
            ///   <see href="https://learn.microsoft.com/windows/win32/api/d2d1_1/nf-d2d1_1-id2d1devicecontext-creategradientstopcollection#parameters">Read more on learn.microsoft.com</see>.</para></param>
            /// <param name="gradientStopCollection1"><para>Type: <b><a href="https://learn.microsoft.com/windows/desktop/api/d2d1_1/nn-d2d1_1-id2d1gradientstopcollection1">ID2D1GradientStopCollection1</a>**</b> The new gradient stop collection.</para>
            /// <para>
            ///   <see href="https://learn.microsoft.com/windows/win32/api/d2d1_1/nf-d2d1_1-id2d1devicecontext-creategradientstopcollection#parameters">Read more on learn.microsoft.com</see>.</para></param>
            /// <returns>
            /// <para>Type: <b>HRESULT</b> The method returns an <b>HRESULT</b>. Possible values include, but are not limited to, those in the following table. </para>
            ...
            /// </returns>
            /// <remarks>
            /// <para>This method linearly interpolates between the color stops. An optional color space conversion is applied post-interpolation. Whether and how this gamma conversion is applied is determined by the pre- and post-interpolation. This method will fail if the device context does not support the requested buffer precision. In order to get the desired result, you need to ensure that the inputs are specified in the correct color space.</para>
            /// <para>You must always specify colors in straight alpha, regardless of interpolation mode being premultiplied or straight. The interpolation mode only affects the interpolated values. Likewise, the stops returned by <a href="https://learn.microsoft.com/windows/desktop/api/d2d1/nf-d2d1-id2d1gradientstopcollection-getgradientstops">ID2D1GradientStopCollection::GetGradientStops</a> will always have straight alpha. If you specify <a href="https://learn.microsoft.com/windows/desktop/api/d2d1_1/ne-d2d1_1-d2d1_color_interpolation_mode">D2D1_COLOR_INTERPOLATION_MODE_PREMULTIPLIED</a>, then all stops are premultiplied before interpolation, and then un-premultiplied before color conversion.</para>
            /// <para>Starting with Windows 8, the interpolation behavior of this method has changed. The table here shows the behavior in Windows 7 and earlier. </para>
            /// <para>This doc was truncated.</para>
            /// <para>
            ///   <see href="https://learn.microsoft.com/windows/win32/api/d2d1_1/nf-d2d1_1-id2d1devicecontext-creategradientstopcollection#">Read more on docs.microsoft.com</see>.</para>
            /// </remarks>
            ...
            /// </summary>
            /// <param name="image"><para>Type: <b><a href="https://learn.microsoft.com/windows/desktop/api/d2d1/nn-d2d1-id2d1image">ID2D1Image</a>*</b> The image to be used as a source for the image brush.</para>
            /// <para>
            ///   <see href="https://learn.microsoft.com/windows/win32/api/d2d1_1/nf-d2d1_1-id2d1devicecontext-createimagebrush(id2d1image_constd2d1_image_brush_properties__constd2d1_brush_properties__id2d1imagebrush)#parameters">Read more on docs.microsoft.com</see>.</para></param>
            /// <param name="imageBrushProperties"><para>Type: <b>const <a href="https://learn.microsoft.com/windows/desktop/api/d2d1_1/ns-d2d1_1-d2d1_image_brush_properties">D2D1_IMAGE_BRUSH_PROPERTIES</a></b> The properties specific to an image brush.</para>
            /// <para>
            ///   <see href="https://learn.microsoft.com/windows/win32/api/d2d1_1/nf-d2d1_1-id2d1devicecontext-createimagebrush(id2d1image_constd2d1_image_brush_properties__constd2d1_brush_properties__id2d1imagebrush)#parameters">Read more on docs.microsoft.com</see>.</para></param>
            /// <param name="brushProperties"><para>Type: <b>const <a href="https://learn.microsoft.com/windows/desktop/api/d2d1/ns-d2d1-d2d1_brush_properties">D2D1_BRUSH_PROPERTIES</a></b> Properties  common to all brushes.</para>
            /// <para>
            ///   <see href="https://learn.microsoft.com/windows/win32/api/d2d1_1/nf-d2d1_1-id2d1devicecontext-createimagebrush(id2d1image_constd2d1_image_brush_properties__constd2d1_brush_properties__id2d1imagebrush)#parameters">Read more on docs.microsoft.com</see>.</para></param>
            /// <param name="imageBrush"><para>Type: <b><a href="https://learn.microsoft.com/windows/desktop/api/d2d1_1/nn-d2d1_1-id2d1imagebrush">ID2D1ImageBrush</a>**</b> When this method returns, contains the address of a pointer to the  input rectangles.</para>
            /// <para>
            ///   <see href="https://learn.microsoft.com/windows/win32/api/d2d1_1/nf-d2d1_1-id2d1devicecontext-createimagebrush(id2d1image_constd2d1_image_brush_properties__constd2d1_brush_properties__id2d1imagebrush)#parameters">Read more on docs.microsoft.com</see>.</para></param>
            /// <returns>
            /// <para>Type: <b>HRESULT</b> The method returns an <b>HRESULT</b>. Possible values include, but are not limited to, those in the following table. </para>
            ...
            /// </returns>
            /// <remarks>
            /// <para>The image brush can be used to fill an arbitrary geometry, an opacity mask or text. This sample illustrates drawing a rectangle with an image brush.</para>
            /// <para></para>
            /// <para>This doc was truncated.</para>
            /// <para>
            ///   <see href="https://learn.microsoft.com/windows/win32/api/d2d1_1/nf-d2d1_1-id2d1devicecontext-createimagebrush(id2d1image_constd2d1_image_brush_properties__constd2d1_brush_properties__id2d1imagebrush)#">Read more on docs.microsoft.com</see>.</para>
            /// </remarks>
            ...
            /// </summary>
            /// <param name="commandList"><para>Type: <b><a href="https://learn.microsoft.com/windows/desktop/api/d2d1_1/nn-d2d1_1-id2d1commandlist">ID2D1CommandList</a>**</b> When this method returns, contains the address of a pointer to a command list.</para>
            /// <para>
            ///   <see href="https://learn.microsoft.com/windows/win32/api/d2d1_1/nf-d2d1_1-id2d1devicecontext-createcommandlist#parameters">Read more on learn.microsoft.com</see>.</para></param>
            /// <returns>
            /// <para>Type: <b>HRESULT</b> The method returns an <b>HRESULT</b>. Possible values include, but are not limited to, those in the following table. </para>
            /// <para>This doc was truncated.</para>
            /// </returns>
            /// <remarks>
            ///   <see href="https://learn.microsoft.com/windows/win32/api/d2d1_1/nf-d2d1_1-id2d1devicecontext-createcommandlist">Learn more about this API from learn.microsoft.com</see>.
            /// </remarks>
            ...
            /// </summary>
            /// <param name="format"><para>Type: <b>format</b> The DXGI format to check.</para>
            /// <para>
            ///   <see href="https://learn.microsoft.com/windows/win32/api/d2d1_1/nf-d2d1_1-id2d1devicecontext-isdxgiformatsupported#parameters">Read more on learn.microsoft.com</see>.</para></param>
            /// <returns>
            /// Type: <b>BOOL</b> Returns TRUE if the format is supported.  Returns FALSE if the format is not supported.
            /// </returns>
            /// <remarks>
            ///   <see href="https://learn.microsoft.com/windows/win32/api/d2d1_1/nf-d2d1_1-id2d1devicecontext-isdxgiformatsupported">Learn more about this API from learn.microsoft.com</see>.
            /// </remarks>
            [PreserveSig]
            ...
            /// </summary>
            /// <param name="bufferPrecision"><para>Type: <b><a href="https://learn.microsoft.com/windows/desktop/api/d2d1_1/ne-d2d1_1-d2d1_buffer_precision">D2D1_BUFFER_PRECISION</a></b> The buffer precision to check.</para>
            /// <para>
            ///   <see href="https://learn.microsoft.com/windows/win32/api/d2d1_1/nf-d2d1_1-id2d1devicecontext-isbufferprecisionsupported#parameters">Read more on learn.microsoft.com</see>.</para></param>
            /// <returns>
            /// Type: <b>BOOL</b> Returns TRUE if the buffer precision is supported.  Returns FALSE if the buffer precision is not supported.
            /// </returns>
            /// <remarks>
            ///   <see href="https://learn.microsoft.com/windows/win32/api/d2d1_1/nf-d2d1_1-id2d1devicecontext-isbufferprecisionsupported">Learn more about this API from learn.microsoft.com</see>.
            /// </remarks>
            [PreserveSig]
            ...
            /// </summary>
            /// <param name="image"><para>Type: <b><a href="https://learn.microsoft.com/windows/desktop/api/d2d1/nn-d2d1-id2d1image">ID2D1Image</a>*</b> The image whose bounds will be calculated.</para>
            /// <para>
            ///   <see href="https://learn.microsoft.com/windows/win32/api/d2d1_1/nf-d2d1_1-id2d1devicecontext-getimagelocalbounds#parameters">Read more on learn.microsoft.com</see>.</para></param>
            /// <param name="localBounds"><para>Type: <b><a href="https://learn.microsoft.com/windows/desktop/Direct2D/d2d1-rect-f">D2D1_RECT_F</a>[1]</b> When this method returns, contains a pointer to the bounds of the image in device independent pixels (DIPs) and in local space.</para>
            /// <para>
            ///   <see href="https://learn.microsoft.com/windows/win32/api/d2d1_1/nf-d2d1_1-id2d1devicecontext-getimagelocalbounds#parameters">Read more on learn.microsoft.com</see>.</para></param>
            /// <returns>
            ...
            /// </returns>
            /// <remarks>
            ///   <see href="https://learn.microsoft.com/windows/win32/api/d2d1_1/nf-d2d1_1-id2d1devicecontext-getimagelocalbounds">Learn more about this API from learn.microsoft.com</see>.
            /// </remarks>
            ...
            /// <param name="image"><para>Type: <b><a href="https://learn.microsoft.com/windows/desktop/api/d2d1/nn-d2d1-id2d1image">ID2D1Image</a>*</b> The image whose bounds will be calculated.</para>
            /// <para>
            ///   <see href="https://learn.microsoft.com/windows/win32/api/d2d1_1/nf-d2d1_1-id2d1devicecontext-getimageworldbounds#parameters">Read more on learn.microsoft.com</see>.</para></param>
            /// <param name="worldBounds"><para>Type: <b><a href="https://learn.microsoft.com/windows/desktop/Direct2D/d2d1-rect-f">D2D1_RECT_F</a>[1]</b> When this method returns, contains a pointer to the bounds of the image in device independent pixels (DIPs).</para>
            /// <para>
            ///   <see href="https://learn.microsoft.com/windows/win32/api/d2d1_1/nf-d2d1_1-id2d1devicecontext-getimageworldbounds#parameters">Read more on learn.microsoft.com</see>.</para></param>
            /// <returns>
            /// <para>Type: <b>HRESULT</b> The method returns an <b>HRESULT</b>. Possible values include, but are not limited to, those in the following table. </para>
            ...
            /// </returns>
            /// <remarks>
            /// <para>The image bounds reflect the current DPI, unit mode, and world transform of the context.  To get bounds which don't include the world transform, use <a href="https://learn.microsoft.com/windows/desktop/api/d2d1_1/nf-d2d1_1-id2d1devicecontext-getimagelocalbounds">ID2D1DeviceContext::GetImageLocalBounds</a>.</para>
            /// <para>The returned bounds reflect which pixels would be impacted by calling <a href="https://learn.microsoft.com/windows/desktop/api/d2d1_1/nf-d2d1_1-id2d1devicecontext-drawimage(id2d1effect_constd2d1_point_2f_constd2d1_rect_f_d2d1_interpolation_mode_d2d1_composite_mode)">DrawImage</a> with the same image and a target offset of (0,0).  They do not reflect the current clip rectangle set on the device context or the extent of the context’s current target image.</para>
            /// <para><see href="https://learn.microsoft.com/windows/win32/api/d2d1_1/nf-d2d1_1-id2d1devicecontext-getimageworldbounds#">Read more on docs.microsoft.com</see>.</para>
            /// </remarks>
            ...
            /// </summary>
            /// <param name="baselineOrigin"><para>Type: <b><a href="https://learn.microsoft.com/windows/desktop/Direct2D/d2d1-point-2f">D2D1_POINT_2F</a></b> The origin of the baseline for the glyph run.</para>
            /// <para>
            ///   <see href="https://learn.microsoft.com/windows/win32/api/d2d1_1/nf-d2d1_1-id2d1devicecontext-getglyphrunworldbounds#parameters">Read more on learn.microsoft.com</see>.</para></param>
            /// <param name="glyphRun"><para>Type: <b>const <a href="https://learn.microsoft.com/windows/desktop/api/dwrite/ns-dwrite-dwrite_glyph_run">DWRITE_GLYPH_RUN</a>*</b> The glyph run to render.</para>
            /// <para>
            ///   <see href="https://learn.microsoft.com/windows/win32/api/d2d1_1/nf-d2d1_1-id2d1devicecontext-getglyphrunworldbounds#parameters">Read more on learn.microsoft.com</see>.</para></param>
            /// <param name="measuringMode"><para>Type: <b><a href="https://learn.microsoft.com/windows/desktop/api/dcommon/ne-dcommon-dwrite_measuring_mode">DWRITE_MEASURING_MODE</a></b> The DirectWrite measuring mode that indicates how glyph metrics are used to measure text when it is formatted.</para>
            /// <para>
            ///   <see href="https://learn.microsoft.com/windows/win32/api/d2d1_1/nf-d2d1_1-id2d1devicecontext-getglyphrunworldbounds#parameters">Read more on learn.microsoft.com</see>.</para></param>
            /// <param name="bounds"><para>Type: <b><a href="https://learn.microsoft.com/windows/desktop/Direct2D/d2d1-rect-f">D2D1_RECT_F</a>*</b> The bounds of the glyph run in DIPs and in world space.</para>
            /// <para>
            ///   <see href="https://learn.microsoft.com/windows/win32/api/d2d1_1/nf-d2d1_1-id2d1devicecontext-getglyphrunworldbounds#parameters">Read more on learn.microsoft.com</see>.</para></param>
            /// <returns>
            /// <para>Type: <b>HRESULT</b> The method returns an <b>HRESULT</b>. Possible values include, but are not limited to, those in the following table. </para>
            ...
            ///   <see href="https://learn.microsoft.com/windows/win32/api/d2d1_1/nf-d2d1_1-id2d1devicecontext-getglyphrunworldbounds">Learn more about this API from learn.microsoft.com</see>.
            /// </remarks>
            ...
            /// </summary>
            /// <param name="device"><para>Type: <b><a href="https://learn.microsoft.com/windows/desktop/api/d2d1_1/nn-d2d1_1-id2d1device">ID2D1Device</a>**</b> When this method returns, contains the address of a pointer to a Direct2D device associated with this device context.</para>
            /// <para>
            ///   <see href="https://learn.microsoft.com/windows/win32/api/d2d1_1/nf-d2d1_1-id2d1devicecontext-getdevice#parameters">Read more on learn.microsoft.com</see>.</para></param>
            /// <remarks>
            /// <para>The application can retrieve the device even if it is created from an earlier render target code-path. The application must use an <a href="https://learn.microsoft.com/windows/desktop/api/d2d1_1/nn-d2d1_1-id2d1devicecontext">ID2D1DeviceContext</a> interface and then call <b>GetDevice</b>. Some functionality for controlling all of the resources for a set of device contexts is maintained only on an <a href="https://learn.microsoft.com/windows/desktop/api/d2d1_1/nn-d2d1_1-id2d1device">ID2D1Device</a> object.</para>
            /// <para>
            ///   <see href="https://learn.microsoft.com/windows/win32/api/d2d1_1/nf-d2d1_1-id2d1devicecontext-getdevice#">Read more on learn.microsoft.com</see>.</para>
            /// </remarks>
            [PreserveSig]
            ...
            /// </summary>
            /// <param name="image"><para>Type: <b><a href="https://learn.microsoft.com/windows/desktop/api/d2d1/nn-d2d1-id2d1image">ID2D1Image</a>*</b> The surface or command list to which the Direct2D device context will render.</para>
            /// <para>
            ///   <see href="https://learn.microsoft.com/windows/win32/api/d2d1_1/nf-d2d1_1-id2d1devicecontext-settarget#parameters">Read more on learn.microsoft.com</see>.</para></param>
            /// <remarks>
            /// <para>The target can be changed at any time, including while the context is drawing. The target can be either a bitmap created with the <a href="https://learn.microsoft.com/windows/desktop/api/d2d1_1/ne-d2d1_1-d2d1_bitmap_options">D2D1_BITMAP_OPTIONS_TARGET</a> flag, or it can be a command list. Other kinds of images cannot be set as a target. For example, you cannot set the output of an effect as target. If the target is not valid the context will enter the <b>D2DERR_INVALID_TARGET </b>error state. You cannot  use <b>SetTarget</b> to render to a bitmap/command list from multiple device contexts simultaneously. An image is considered “being rendered to” if it has ever been set on a device context within a <a href="https://learn.microsoft.com/windows/desktop/api/d2d1/nf-d2d1-id2d1rendertarget-begindraw">BeginDraw</a>/<a href="https://learn.microsoft.com/windows/desktop/api/d2d1/nf-d2d1-id2d1rendertarget-enddraw">EndDraw</a> timespan. If an attempt is made to render to an image through multiple device contexts, all subsequent device contexts after the first will enter an error state.</para>
            /// <para>Callers wishing to attach an image to a second device context should first call <a href="https://learn.microsoft.com/windows/desktop/api/d2d1/nf-d2d1-id2d1rendertarget-enddraw">EndDraw</a> on the first device context.</para>
            /// <para>Here is an example of the correct calling order.</para>
            /// <para></para>
            /// <para>This doc was truncated.</para>
            /// <para>
            ///   <see href="https://learn.microsoft.com/windows/win32/api/d2d1_1/nf-d2d1_1-id2d1devicecontext-settarget#">Read more on learn.microsoft.com</see>.</para>
            /// </remarks>
            [PreserveSig]
            ...
            /// </summary>
            /// <param name="image"><para>Type: <b><a href="https://learn.microsoft.com/windows/desktop/api/d2d1/nn-d2d1-id2d1image">ID2D1Image</a>**</b> When this method returns, contains the address of a pointer to the target currently associated with the device context.</para>
            /// <para>
            ///   <see href="https://learn.microsoft.com/windows/win32/api/d2d1_1/nf-d2d1_1-id2d1devicecontext-gettarget#parameters">Read more on learn.microsoft.com</see>.</para></param>
            /// <remarks>
            ...
            /// <para>This doc was truncated.</para>
            /// <para>
            ///   <see href="https://learn.microsoft.com/windows/win32/api/d2d1_1/nf-d2d1_1-id2d1devicecontext-gettarget#">Read more on learn.microsoft.com</see>.</para>
            /// </remarks>
            [PreserveSig]
            ...
            /// </summary>
            /// <param name="renderingControls"><para>Type: <b>const <a href="https://learn.microsoft.com/windows/desktop/api/d2d1_1/ns-d2d1_1-d2d1_rendering_controls">D2D1_RENDERING_CONTROLS</a>*</b> The rendering controls to be applied.</para>
            /// <para>
            ///   <see href="https://learn.microsoft.com/windows/win32/api/d2d1_1/nf-d2d1_1-id2d1devicecontext-setrenderingcontrols(constd2d1_rendering_controls_)#parameters">Read more on docs.microsoft.com</see>.</para></param>
            /// <remarks>
            ...
            /// </summary>
            /// <param name="renderingControls"><para>Type: <b><a href="https://learn.microsoft.com/windows/desktop/api/d2d1_1/ns-d2d1_1-d2d1_rendering_controls">D2D1_RENDERING_CONTROLS</a>*</b> When this method returns, contains a pointer to the rendering controls for this context.</para>
            /// <para>
            ///   <see href="https://learn.microsoft.com/windows/win32/api/d2d1_1/nf-d2d1_1-id2d1devicecontext-getrenderingcontrols#parameters">Read more on learn.microsoft.com</see>.</para></param>
            /// <remarks>
            ///   <see href="https://learn.microsoft.com/windows/win32/api/d2d1_1/nf-d2d1_1-id2d1devicecontext-getrenderingcontrols">Learn more about this API from learn.microsoft.com</see>.
            /// </remarks>
            [PreserveSig]
            ...
            /// </summary>
            /// <param name="primitiveBlend"><para>Type: <b><a href="https://learn.microsoft.com/windows/desktop/api/d2d1_1/ne-d2d1_1-d2d1_primitive_blend">D2D1_PRIMITIVE_BLEND</a></b> The primitive blend to use.</para>
            /// <para>
            ///   <see href="https://learn.microsoft.com/windows/win32/api/d2d1_1/nf-d2d1_1-id2d1devicecontext-setprimitiveblend#parameters">Read more on learn.microsoft.com</see>.</para></param>
            /// <remarks>
            /// <para>The primitive blend will apply to all of the primitive drawn on the context, unless this is overridden with the <i>compositeMode</i> parameter on the <a href="https://learn.microsoft.com/windows/desktop/api/d2d1_1/nf-d2d1_1-id2d1devicecontext-drawimage(id2d1effect_constd2d1_point_2f_constd2d1_rect_f_d2d1_interpolation_mode_d2d1_composite_mode)">DrawImage</a> API. The primitive blend applies to the interior of any primitives drawn on the context. In the case of <a href="https://learn.microsoft.com/windows/desktop/api/d2d1_1/nf-d2d1_1-id2d1devicecontext-drawimage(id2d1effect_constd2d1_point_2f_constd2d1_rect_f_d2d1_interpolation_mode_d2d1_composite_mode)">DrawImage</a>, this will be implied by the image rectangle, offset and world transform. If the primitive blend is anything other than <b>D2D1_PRIMITIVE_BLEND_SOURCE_OVER</b> then ClearType rendering will be turned off. If the application explicitly forces ClearType rendering in these modes, the drawing context will be placed in an error state. D2DERR_WRONG_STATE will be returned from either <a href="https://learn.microsoft.com/windows/desktop/api/d2d1/nf-d2d1-id2d1rendertarget-enddraw">EndDraw</a> or <a href="https://learn.microsoft.com/windows/desktop/api/d2d1/nf-d2d1-id2d1rendertarget-flush">Flush</a>.</para>
            /// <para>
            ///   <see href="https://learn.microsoft.com/windows/win32/api/d2d1_1/nf-d2d1_1-id2d1devicecontext-setprimitiveblend#">Read more on learn.microsoft.com</see>.</para>
            /// </remarks>
            [PreserveSig]
            ...
            /// </summary>
            /// <returns>
            /// Type: <b><a href="https://learn.microsoft.com/windows/desktop/api/d2d1_1/ne-d2d1_1-d2d1_primitive_blend">D2D1_PRIMITIVE_BLEND</a></b> The current primitive blend. The default value is <b>D2D1_PRIMITIVE_BLEND_SOURCE_OVER</b>.
            /// </returns>
            /// <remarks>
            ///   <see href="https://learn.microsoft.com/windows/win32/api/d2d1_1/nf-d2d1_1-id2d1devicecontext-getprimitiveblend">Learn more about this API from learn.microsoft.com</see>.
            /// </remarks>
            [PreserveSig]
            ...
            /// </summary>
            /// <param name="unitMode"><para>Type: <b><a href="https://learn.microsoft.com/windows/desktop/api/d2d1_1/ne-d2d1_1-d2d1_unit_mode">D2D1_UNIT_MODE</a></b> An enumeration defining how passed-in units will be interpreted by the device context.</para>
            /// <para>
            ///   <see href="https://learn.microsoft.com/windows/win32/api/d2d1_1/nf-d2d1_1-id2d1devicecontext-setunitmode#parameters">Read more on learn.microsoft.com</see>.</para></param>
            /// <remarks>
            /// <para>This method will affect all properties and parameters affected by <a href="https://learn.microsoft.com/windows/desktop/api/d2d1/nf-d2d1-id2d1rendertarget-setdpi">SetDpi</a> and <a href="https://learn.microsoft.com/windows/desktop/api/d2d1/nf-d2d1-id2d1rendertarget-getdpi">GetDpi</a>. This affects all coordinates, lengths, and other properties that are not explicitly defined as being in another unit. For example: </para>
            /// <para>This doc was truncated.</para>
            /// <para>
            ///   <see href="https://learn.microsoft.com/windows/win32/api/d2d1_1/nf-d2d1_1-id2d1devicecontext-setunitmode#">Read more on learn.microsoft.com</see>.</para>
            /// </remarks>
            [PreserveSig]
            ...
            /// </summary>
            /// <returns>
            /// Type: <b><a href="https://learn.microsoft.com/windows/desktop/api/d2d1_1/ne-d2d1_1-d2d1_unit_mode">D2D1_UNIT_MODE</a></b> The  unit mode.
            /// </returns>
            /// <remarks>
            ///   <see href="https://learn.microsoft.com/windows/win32/api/d2d1_1/nf-d2d1_1-id2d1devicecontext-getunitmode">Learn more about this API from learn.microsoft.com</see>.
            /// </remarks>
            [PreserveSig]
            ...
            /// <param name="baselineOrigin"><para>Type: <b><a href="https://learn.microsoft.com/windows/desktop/Direct2D/d2d1-point-2f">D2D1_POINT_2F</a></b> Origin of first glyph in the series.</para>
            /// <para>
            ///   <see href="https://learn.microsoft.com/windows/win32/api/d2d1_1/nf-d2d1_1-id2d1devicecontext-drawglyphrun#parameters">Read more on learn.microsoft.com</see>.</para></param>
            /// <param name="glyphRun"><para>Type: <b>const <a href="https://learn.microsoft.com/windows/desktop/api/dwrite/ns-dwrite-dwrite_glyph_run">DWRITE_GLYPH_RUN</a>*</b> The glyphs to render.</para>
            /// <para>
            ///   <see href="https://learn.microsoft.com/windows/win32/api/d2d1_1/nf-d2d1_1-id2d1devicecontext-drawglyphrun#parameters">Read more on learn.microsoft.com</see>.</para></param>
            /// <param name="glyphRunDescription"><para>Type: <b>const <a href="https://learn.microsoft.com/windows/desktop/api/dwrite/ns-dwrite-dwrite_glyph_run_description">DWRITE_GLYPH_RUN_DESCRIPTION</a>*</b> Supplementary glyph series information.</para>
            /// <para>
            ///   <see href="https://learn.microsoft.com/windows/win32/api/d2d1_1/nf-d2d1_1-id2d1devicecontext-drawglyphrun#parameters">Read more on learn.microsoft.com</see>.</para></param>
            /// <param name="foregroundBrush"><para>Type: <b><a href="https://learn.microsoft.com/windows/desktop/api/d2d1/nn-d2d1-id2d1brush">ID2D1Brush</a>*</b> The brush that defines the text color.</para>
            /// <para>
            ...
            /// <para>
            ///   <see href="https://learn.microsoft.com/windows/win32/api/d2d1_1/nf-d2d1_1-id2d1devicecontext-drawglyphrun#">Read more on learn.microsoft.com</see>.</para>
            /// </remarks>
            [PreserveSig]
            ...
            /// <param name="targetOffset"><para>Type: <b>const <a href="https://learn.microsoft.com/windows/desktop/Direct2D/d2d1-point-2f">D2D1_POINT_2F</a>*</b> The  offset in the destination space that the image will be rendered to. The entire logical extent of the image will be rendered to the corresponding destination. If not specified, the destination origin will be (0, 0). The top-left corner of the image will be mapped to the target offset. This will not necessarily be the origin. This default value is <i>NULL</i>.</para>
            /// <para>
            ///   <see href="https://learn.microsoft.com/windows/win32/api/d2d1_1/nf-d2d1_1-id2d1devicecontext-drawimage(id2d1effect_d2d1_point_2f_d2d1_interpolation_mode_d2d1_composite_mode)#parameters">Read more on docs.microsoft.com</see>.</para></param>
            /// <param name="imageRectangle">The image rectangle.</param>
            /// <param name="interpolationMode"><para>Type: <b><a href="https://learn.microsoft.com/windows/desktop/api/d2d1_1/ne-d2d1_1-d2d1_interpolation_mode">D2D1_INTERPOLATION_MODE</a></b> The interpolation mode that will be used to scale the image if necessary.</para>
            /// <para>
            ///   <see href="https://learn.microsoft.com/windows/win32/api/d2d1_1/nf-d2d1_1-id2d1devicecontext-drawimage(id2d1effect_d2d1_point_2f_d2d1_interpolation_mode_d2d1_composite_mode)#parameters">Read more on docs.microsoft.com</see>.</para></param>
            /// <param name="compositeMode"><para>Type: <b><a href="https://learn.microsoft.com/windows/desktop/api/d2d1_1/ne-d2d1_1-d2d1_composite_mode">D2D1_COMPOSITE_MODE</a></b> The composite mode that will be applied to the limits of the currently selected clip. The default value is <b>D2D1_COMPOSITE_MODE_SOURCE_OVER</b></para>
            /// <para>
            ///   <see href="https://learn.microsoft.com/windows/win32/api/d2d1_1/nf-d2d1_1-id2d1devicecontext-drawimage(id2d1effect_d2d1_point_2f_d2d1_interpolation_mode_d2d1_composite_mode)#parameters">Read more on docs.microsoft.com</see>.</para></param>
            /// <remarks>
            /// <para>If <i>interpolationMode</i> is <b>D2D1_INTERPOLATION_MODE_HIGH_QUALITY</b>, different scalers will be used depending on the scale factor implied by the world transform. Any invalid rectangles accumulated on any effect that is drawn by this call will be discarded regardless of which portion of the image rectangle is drawn. If <i>compositeMode</i> is <b>D2D1_COMPOSITE_MODE_SOURCE_OVER</b>, <a href="https://learn.microsoft.com/windows/desktop/api/d2d1_1/nf-d2d1_1-id2d1devicecontext-drawimage(id2d1effect_constd2d1_point_2f_constd2d1_rect_f_d2d1_interpolation_mode_d2d1_composite_mode)">DrawImage</a> will use the currently selected primitive blend specified by <a href="https://learn.microsoft.com/windows/desktop/api/d2d1_1/nf-d2d1_1-id2d1devicecontext-setprimitiveblend">ID2D1DeviceContext::SetPrimitiveBlend</a>. If <i>compositeMode</i> is not <b>D2D1_COMPOSITE_MODE_SOURCE_OVER</b>, the image will be extended to transparent up to the current axis-aligned clip. If there is an image rectangle and a world transform, this is equivalent to inserting a clip effect to represent the image rectangle and a 2D affine transform to take into account the world transform.</para>
            /// <para>
            ///   <see href="https://learn.microsoft.com/windows/win32/api/d2d1_1/nf-d2d1_1-id2d1devicecontext-drawimage(id2d1effect_d2d1_point_2f_d2d1_interpolation_mode_d2d1_composite_mode)#">Read more on docs.microsoft.com</see>.</para>
            /// </remarks>
            [PreserveSig]
            ...
            /// </summary>
            /// <param name="gdiMetafile"><para>Type: <b><a href="https://learn.microsoft.com/windows/desktop/api/d2d1_1/nn-d2d1_1-id2d1gdimetafile">ID2D1GdiMetafile</a>*</b> The metafile to draw.</para>
            /// <para>
            ///   <see href="https://learn.microsoft.com/windows/win32/api/d2d1_1/nf-d2d1_1-id2d1devicecontext-drawgdimetafile(id2d1gdimetafile_d2d1_point_2f)#parameters">Read more on docs.microsoft.com</see>.</para></param>
            /// <param name="targetOffset"><para>Type: <b>const <a href="https://learn.microsoft.com/windows/desktop/Direct2D/d2d1-point-2f">D2D1_POINT_2F</a>*</b> The offset from the upper left corner of the render target.</para>
            /// <para>
            ///   <see href="https://learn.microsoft.com/windows/win32/api/d2d1_1/nf-d2d1_1-id2d1devicecontext-drawgdimetafile(id2d1gdimetafile_d2d1_point_2f)#parameters">Read more on docs.microsoft.com</see>.</para></param>
            /// <remarks>
            ///   <see href="https://learn.microsoft.com/windows/win32/api/d2d1_1/nf-d2d1_1-id2d1devicecontext-drawgdimetafile(id2d1gdimetafile_d2d1_point_2f)">Learn more about this API from docs.microsoft.com</see>.
            /// </remarks>
            [PreserveSig]
            ...
            /// <para>
            ///   <see href="https://learn.microsoft.com/windows/win32/api/d2d1_1/nf-d2d1_1-id2d1devicecontext-drawbitmap(id2d1bitmap_constd2d1_rect_f__float_d2d1_interpolation_mode_constd2d1_rect_f__constd2d1_matrix_4x4_f_)#parameters">Read more on docs.microsoft.com</see>.</para></param>
            /// <param name="perspectiveTransform"><para>Type: <b>const <a href="https://learn.microsoft.com/windows/desktop/Direct2D/d2d1-matrix-4x4-f">D2D1_MATRIX_4X4_F</a></b> An optional perspective transform.</para>
            /// <para>
            ///   <see href="https://learn.microsoft.com/windows/win32/api/d2d1_1/nf-d2d1_1-id2d1devicecontext-drawbitmap(id2d1bitmap_constd2d1_rect_f__float_d2d1_interpolation_mode_constd2d1_rect_f__constd2d1_matrix_4x4_f_)#parameters">Read more on docs.microsoft.com</see>.</para></param>
            /// <remarks>
            /// <para>The destinationRectangle parameter defines the rectangle in the target where the bitmap will appear (in device-independent pixels (DIPs)).  This is affected by the currently set transform and the perspective transform, if set.  If NULL is specified, then the destination rectangle is (left=0, top=0, right = width(sourceRectangle), bottom = height(sourceRectangle)).</para>
            ...
            /// </summary>
            /// <param name="effect"><para>Type: <b><a href="https://learn.microsoft.com/windows/desktop/api/d2d1_1/nn-d2d1_1-id2d1effect">ID2D1Effect</a>*</b> The effect to invalidate.</para>
            /// <para>
            ///   <see href="https://learn.microsoft.com/windows/win32/api/d2d1_1/nf-d2d1_1-id2d1devicecontext-invalidateeffectinputrectangle#parameters">Read more on learn.microsoft.com</see>.</para></param>
            /// <param name="input"><para>Type: <b>UINT32</b> The input index.</para>
            /// <para>
            ///   <see href="https://learn.microsoft.com/windows/win32/api/d2d1_1/nf-d2d1_1-id2d1devicecontext-invalidateeffectinputrectangle#parameters">Read more on learn.microsoft.com</see>.</para></param>
            /// <param name="inputRectangle"><para>Type: <b>const <a href="https://learn.microsoft.com/windows/desktop/Direct2D/d2d1-rect-f">D2D1_RECT_F</a>*</b> The rect to invalidate.</para>
            /// <para>
            ///   <see href="https://learn.microsoft.com/windows/win32/api/d2d1_1/nf-d2d1_1-id2d1devicecontext-invalidateeffectinputrectangle#parameters">Read more on learn.microsoft.com</see>.</para></param>
            /// <returns>
            /// <para>Type: <b>HRESULT</b> The method returns an <b>HRESULT</b>. Possible values include, but are not limited to, those in the following table. </para>
            ...
            /// </returns>
            /// <remarks>
            ///   <see href="https://learn.microsoft.com/windows/win32/api/d2d1_1/nf-d2d1_1-id2d1devicecontext-invalidateeffectinputrectangle">Learn more about this API from learn.microsoft.com</see>.
            /// </remarks>
            ...
            /// </summary>
            /// <param name="effect"><para>Type: <b><a href="https://learn.microsoft.com/windows/desktop/api/d2d1_1/nn-d2d1_1-id2d1effect">ID2D1Effect</a>*</b> The effect to count the invalid rectangles on.</para>
            /// <para>
            ///   <see href="https://learn.microsoft.com/windows/win32/api/d2d1_1/nf-d2d1_1-id2d1devicecontext-geteffectinvalidrectanglecount#parameters">Read more on learn.microsoft.com</see>.</para></param>
            /// <param name="rectangleCount"><para>Type: <b>UINT32*</b> The returned rectangle count.</para>
            /// <para>
            ///   <see href="https://learn.microsoft.com/windows/win32/api/d2d1_1/nf-d2d1_1-id2d1devicecontext-geteffectinvalidrectanglecount#parameters">Read more on learn.microsoft.com</see>.</para></param>
            /// <returns>
            /// <para>Type: <b>HRESULT</b> The method returns an <b>HRESULT</b>. Possible values include, but are not limited to, those in the following table. </para>
            ...
            /// </returns>
            /// <remarks>
            ///   <see href="https://learn.microsoft.com/windows/win32/api/d2d1_1/nf-d2d1_1-id2d1devicecontext-geteffectinvalidrectanglecount">Learn more about this API from learn.microsoft.com</see>.
            /// </remarks>
            new void GetEffectInvalidRectangleCount(ID2D1Effect effect, out uint rectangleCount);
            ...
            /// </summary>
            /// <param name="effect"><para>Type: <b><a href="https://learn.microsoft.com/windows/desktop/api/d2d1_1/nn-d2d1_1-id2d1effect">ID2D1Effect</a>*</b> The effect to get the invalid rectangles from.</para>
            /// <para>
            ///   <see href="https://learn.microsoft.com/windows/win32/api/d2d1_1/nf-d2d1_1-id2d1devicecontext-geteffectinvalidrectangles#parameters">Read more on docs.microsoft.com</see>.</para></param>
            /// <param name="rectangles"><para>Type: <b><a href="https://learn.microsoft.com/windows/desktop/Direct2D/d2d1-rect-f">D2D1_RECT_F</a>*</b> An array of <a href="https://learn.microsoft.com/windows/desktop/Direct2D/d2d1-rect-f">D2D1_RECT_F</a> structures.  You must allocate this to the correct size.  You can get the count of the invalid rectangles using the <a href="https://learn.microsoft.com/windows/desktop/api/d2d1_1/nf-d2d1_1-id2d1devicecontext-geteffectinvalidrectanglecount">GetEffectInvalidRectangleCount</a> method.</para>
            /// <para>
            ///   <see href="https://learn.microsoft.com/windows/win32/api/d2d1_1/nf-d2d1_1-id2d1devicecontext-geteffectinvalidrectangles#parameters">Read more on docs.microsoft.com</see>.</para></param>
            /// <param name="rectanglesCount"><para>Type: <b>UINT32</b> The number of rectangles to get.</para>
            /// <para>
            ///   <see href="https://learn.microsoft.com/windows/win32/api/d2d1_1/nf-d2d1_1-id2d1devicecontext-geteffectinvalidrectangles#parameters">Read more on docs.microsoft.com</see>.</para></param>
            /// <returns>
            /// <para>Type: <b>HRESULT</b> The method returns an <b>HRESULT</b>. Possible values include, but are not limited to, those in the following table. </para>
            ...
            /// <para>
            ///   <div class="alert">
            ///     <b>Note</b>  Direct2D does not automatically use these invalid rectangles to reduce the region of an effect that is rendered.</div>
            ///   <div> </div>
            /// </para>
            /// <para>You can use the <a href="https://learn.microsoft.com/windows/desktop/api/d2d1_1/nf-d2d1_1-id2d1devicecontext-invalidateeffectinputrectangle">InvalidateEffectInputRectangle</a> method to specify invalidated rectangles for Direct2D to propagate through an effect graph. If multiple invalid rectangles are requested, the rectangles that this method returns may overlap. When this is the case, the rectangle count might be lower than the count that <a href="https://learn.microsoft.com/windows/desktop/api/d2d1_1/nf-d2d1_1-id2d1devicecontext-geteffectinvalidrectanglecount">GetEffectInvalidRectangleCount</a>.</para>
            /// <para>
            ///   <see href="https://learn.microsoft.com/windows/win32/api/d2d1_1/nf-d2d1_1-id2d1devicecontext-geteffectinvalidrectangles#">Read more on docs.microsoft.com</see>.</para>
            /// </remarks>
            ...
            /// </summary>
            /// <param name="renderEffect"><para>Type: <b><a href="https://learn.microsoft.com/windows/desktop/api/d2d1_1/nn-d2d1_1-id2d1effect">ID2D1Effect</a>*</b> The image whose output is being rendered.</para>
            /// <para>
            ///   <see href="https://learn.microsoft.com/windows/win32/api/d2d1_1/nf-d2d1_1-id2d1devicecontext-geteffectrequiredinputrectangles#parameters">Read more on learn.microsoft.com</see>.</para></param>
            /// <param name="renderImageRectangle"><para>Type: <b>const <a href="https://learn.microsoft.com/windows/desktop/Direct2D/d2d1-rect-f">D2D1_RECT_F</a>*</b> The portion of the output image whose inputs are being inspected.</para>
            /// <para>
            ///   <see href="https://learn.microsoft.com/windows/win32/api/d2d1_1/nf-d2d1_1-id2d1devicecontext-geteffectrequiredinputrectangles#parameters">Read more on learn.microsoft.com</see>.</para></param>
            /// <param name="inputDescriptions"><para>Type: <b>const <a href="https://learn.microsoft.com/windows/desktop/api/d2d1_1/ns-d2d1_1-d2d1_effect_input_description">D2D1_EFFECT_INPUT_DESCRIPTION</a>*</b> A list of the inputs whos rectangles are being queried.</para>
            /// <para>
            ///   <see href="https://learn.microsoft.com/windows/win32/api/d2d1_1/nf-d2d1_1-id2d1devicecontext-geteffectrequiredinputrectangles#parameters">Read more on learn.microsoft.com</see>.</para></param>
            /// <param name="requiredInputRects"><para>Type: <b><a href="https://learn.microsoft.com/windows/desktop/Direct2D/d2d1-rect-f">D2D1_RECT_F</a>*</b> The input rectangles returned to the caller.</para>
            /// <para>
            ///   <see href="https://learn.microsoft.com/windows/win32/api/d2d1_1/nf-d2d1_1-id2d1devicecontext-geteffectrequiredinputrectangles#parameters">Read more on learn.microsoft.com</see>.</para></param>
            /// <param name="inputCount"><para>Type: <b>UINT32</b> The number of inputs.</para>
            /// <para>
            ///   <see href="https://learn.microsoft.com/windows/win32/api/d2d1_1/nf-d2d1_1-id2d1devicecontext-geteffectrequiredinputrectangles#parameters">Read more on learn.microsoft.com</see>.</para></param>
            /// <returns>
            /// Type: <b>HRESULT</b> A failure code, this will typically only be because an effect in the chain returned some error.
            /// </returns>
            /// <remarks>
            ///   <see href="https://learn.microsoft.com/windows/win32/api/d2d1_1/nf-d2d1_1-id2d1devicecontext-geteffectrequiredinputrectangles">Learn more about this API from learn.microsoft.com</see>.
            /// </remarks>
            ...
            /// </summary>
            /// <param name="geometry"><para>Type: <b><a href="https://learn.microsoft.com/windows/desktop/api/d2d1/nn-d2d1-id2d1geometry">ID2D1Geometry</a>*</b> The geometry to realize.</para>
            /// <para>
            ///   <see href="https://learn.microsoft.com/windows/win32/api/d2d1_2/nf-d2d1_2-id2d1devicecontext1-createfilledgeometryrealization#parameters">Read more on learn.microsoft.com</see>.</para></param>
            /// <param name="flatteningTolerance"><para>Type: <b>FLOAT</b> The flattening tolerance to use when converting Beziers to line segments. This parameter shares the same units as the coordinates of the geometry.</para>
            /// <para>
            ///   <see href="https://learn.microsoft.com/windows/win32/api/d2d1_2/nf-d2d1_2-id2d1devicecontext1-createfilledgeometryrealization#parameters">Read more on learn.microsoft.com</see>.</para></param>
            /// <param name="geometryRealization"><para>Type: <b><a href="https://learn.microsoft.com/windows/desktop/api/d2d1_2/nn-d2d1_2-id2d1geometryrealization">ID2D1GeometryRealization</a>**</b> When this method returns, contains the address of a pointer to a new geometry realization object.</para>
            /// <para>
            ///   <see href="https://learn.microsoft.com/windows/win32/api/d2d1_2/nf-d2d1_2-id2d1devicecontext1-createfilledgeometryrealization#parameters">Read more on learn.microsoft.com</see>.</para></param>
            /// <returns>
            /// <para>Type: <b>HRESULT</b> The method returns an <b>HRESULT</b>. Possible values include, but are not limited to, those in the following table. </para>
            ...
            /// </returns>
            /// <remarks>
            ///   <see href="https://learn.microsoft.com/windows/win32/api/d2d1_2/nf-d2d1_2-id2d1devicecontext1-createfilledgeometryrealization">Learn more about this API from learn.microsoft.com</see>.
            /// </remarks>
            ...
            /// <param name="geometry"><para>Type: <b><a href="https://learn.microsoft.com/windows/desktop/api/d2d1/nn-d2d1-id2d1geometry">ID2D1Geometry</a>*</b> The geometry to realize.</para>
            /// <para>
            ///   <see href="https://learn.microsoft.com/windows/win32/api/d2d1_2/nf-d2d1_2-id2d1devicecontext1-createstrokedgeometryrealization#parameters">Read more on learn.microsoft.com</see>.</para></param>
            /// <param name="flatteningTolerance"><para>Type: <b>FLOAT </b> The flattening tolerance to use when converting Beziers to line segments. This parameter shares the same units as the coordinates of the geometry.</para>
            /// <para>
            ///   <see href="https://learn.microsoft.com/windows/win32/api/d2d1_2/nf-d2d1_2-id2d1devicecontext1-createstrokedgeometryrealization#parameters">Read more on learn.microsoft.com</see>.</para></param>
            /// <param name="strokeWidth"><para>Type: <b>FLOAT </b> The width of the stroke. This parameter shares the same units as the coordinates of the geometry.</para>
            /// <para>
            ///   <see href="https://learn.microsoft.com/windows/win32/api/d2d1_2/nf-d2d1_2-id2d1devicecontext1-createstrokedgeometryrealization#parameters">Read more on learn.microsoft.com</see>.</para></param>
            /// <param name="strokeStyle"><para>Type: <b><a href="https://learn.microsoft.com/windows/desktop/api/d2d1/nn-d2d1-id2d1strokestyle">ID2D1StrokeStyle</a>*</b> The stroke style (optional).</para>
            /// <para>
            ///   <see href="https://learn.microsoft.com/windows/win32/api/d2d1_2/nf-d2d1_2-id2d1devicecontext1-createstrokedgeometryrealization#parameters">Read more on learn.microsoft.com</see>.</para></param>
            /// <param name="geometryRealization"><para>Type: <b><a href="https://learn.microsoft.com/windows/desktop/api/d2d1_2/nn-d2d1_2-id2d1geometryrealization">ID2D1GeometryRealization</a>**</b> When this method returns, contains the address of a pointer to a new geometry realization object.</para>
            /// <para>
            ...
            /// </returns>
            /// <remarks>
            ///   <see href="https://learn.microsoft.com/windows/win32/api/d2d1_2/nf-d2d1_2-id2d1devicecontext1-createstrokedgeometryrealization">Learn more about this API from learn.microsoft.com</see>.
            /// </remarks>
            ...
            /// </summary>
            /// <param name="geometryRealization"><para>Type: <b><a href="https://learn.microsoft.com/windows/desktop/api/d2d1_2/nn-d2d1_2-id2d1geometryrealization">ID2D1GeometryRealization</a>*</b> The geometry realization to be rendered.</para>
            /// <para>
            ///   <see href="https://learn.microsoft.com/windows/win32/api/d2d1_2/nf-d2d1_2-id2d1devicecontext1-drawgeometryrealization#parameters">Read more on learn.microsoft.com</see>.</para></param>
            /// <param name="brush"><para>Type: <b><a href="https://learn.microsoft.com/windows/desktop/api/d2d1/nn-d2d1-id2d1brush">ID2D1Brush</a>*</b> The brush to render the realization with.</para>
            /// <para>
            ///   <see href="https://learn.microsoft.com/windows/win32/api/d2d1_2/nf-d2d1_2-id2d1devicecontext1-drawgeometryrealization#parameters">Read more on learn.microsoft.com</see>.</para></param>
            /// <returns>
            /// <para>Type: <b>HRESULT</b> The method returns an <b>HRESULT</b>. Possible values include, but are not limited to, those in the following table.</para>
            ...
            /// </returns>
            /// <remarks>
            ///   <see href="https://learn.microsoft.com/windows/win32/api/d2d1_2/nf-d2d1_2-id2d1devicecontext1-drawgeometryrealization">Learn more about this API from learn.microsoft.com</see>.
            /// </remarks>
            [PreserveSig]
            ...
            /// </summary>
            /// <param name="startPoint"><para>Type: <b>const <a href="https://learn.microsoft.com/windows/desktop/api/d2d1_3/ns-d2d1_3-d2d1_ink_point">D2D1_INK_POINT</a></b> The starting point of the first segment of the first stroke in the new ink object.</para>
            /// <para>
            ///   <see href="https://learn.microsoft.com/windows/win32/api/d2d1_3/nf-d2d1_3-id2d1devicecontext2-createink(constd2d1_ink_point__id2d1ink)#parameters">Read more on docs.microsoft.com</see>.</para></param>
            /// <param name="ink"><para>Type: <b><a href="https://learn.microsoft.com/windows/desktop/api/d2d1_3/nn-d2d1_3-id2d1ink">ID2D1Ink</a>**</b> When this method returns, contains the address of a pointer to a new ink object.</para>
            /// <para>
            ///   <see href="https://learn.microsoft.com/windows/win32/api/d2d1_3/nf-d2d1_3-id2d1devicecontext2-createink(constd2d1_ink_point__id2d1ink)#parameters">Read more on docs.microsoft.com</see>.</para></param>
            /// <returns>
            /// Type: <b><a href="https://learn.microsoft.com/windows/win32/com/structure-of-com-error-codes">HRESULT</a></b> S_OK if successful, otherwise a failure HRESULT.
            /// </returns>
            /// <remarks>
            ///   <see href="https://learn.microsoft.com/windows/win32/api/d2d1_3/nf-d2d1_3-id2d1devicecontext2-createink(constd2d1_ink_point__id2d1ink)">Learn more about this API from docs.microsoft.com</see>.
            /// </remarks>
            new unsafe void CreateInk(D2D1_INK_POINT* startPoint, out ID2D1Ink ink);

            /// <summary>
            /// Creates a new ID2D1InkStyle object, for use with ink rendering methods such as DrawInk. (overload 2/2)
            /// </summary>
            /// <param name="inkStyleProperties"><para>Type: <b>const <a href="https://learn.microsoft.com/windows/desktop/api/d2d1_3/ns-d2d1_3-d2d1_ink_style_properties">D2D1_INK_STYLE_PROPERTIES</a></b> The properties of the ink style to be created.</para>
            /// <para>
            ///   <see href="https://learn.microsoft.com/windows/win32/api/d2d1_3/nf-d2d1_3-id2d1devicecontext2-createinkstyle(constd2d1_ink_style_properties_id2d1inkstyle)#parameters">Read more on docs.microsoft.com</see>.</para></param>
            /// <param name="inkStyle"><para>Type: <b><a href="https://learn.microsoft.com/windows/desktop/api/d2d1_3/nn-d2d1_3-id2d1inkstyle">ID2D1InkStyle</a>**</b> When this method returns, contains the address of a pointer to a new ink style object.</para>
            /// <para>
            ///   <see href="https://learn.microsoft.com/windows/win32/api/d2d1_3/nf-d2d1_3-id2d1devicecontext2-createinkstyle(constd2d1_ink_style_properties_id2d1inkstyle)#parameters">Read more on docs.microsoft.com</see>.</para></param>
            /// <returns>
            /// Type: <b><a href="https://learn.microsoft.com/windows/win32/com/structure-of-com-error-codes">HRESULT</a></b> S_OK if successful, otherwise a failure HRESULT.
            /// </returns>
            /// <remarks>
            ///   <see href="https://learn.microsoft.com/windows/win32/api/d2d1_3/nf-d2d1_3-id2d1devicecontext2-createinkstyle(constd2d1_ink_style_properties_id2d1inkstyle)">Learn more about this API from docs.microsoft.com</see>.
            /// </remarks>
            new unsafe void CreateInkStyle([Optional] D2D1_INK_STYLE_PROPERTIES* inkStyleProperties, out ID2D1InkStyle inkStyle);

            /// <summary>
            /// Creates a new ID2D1GradientMesh instance using the given array of patches.
            /// </summary>
            /// <param name="patches"><para>Type: <b>const <a href="https://learn.microsoft.com/windows/desktop/api/d2d1_3/ns-d2d1_3-d2d1_gradient_mesh_patch">D2D1_GRADIENT_MESH_PATCH</a>*</b> A pointer to the array containing the patches to be used in this mesh.</para>
            /// <para>
            ///   <see href="https://learn.microsoft.com/windows/win32/api/d2d1_3/nf-d2d1_3-id2d1devicecontext2-creategradientmesh#parameters">Read more on docs.microsoft.com</see>.</para></param>
            /// <param name="patchesCount"><para>Type: <b>UINT32</b> The number of patches in the patches argument to read.</para>
            /// <para>
            ///   <see href="https://learn.microsoft.com/windows/win32/api/d2d1_3/nf-d2d1_3-id2d1devicecontext2-creategradientmesh#parameters">Read more on docs.microsoft.com</see>.</para></param>
            /// <param name="gradientMesh"><para>Type: <b><a href="https://learn.microsoft.com/windows/desktop/api/d2d1_3/nn-d2d1_3-id2d1gradientmesh">ID2D1GradientMesh</a>**</b> When this method returns, contains the address of a pointer to the new gradient mesh.</para>
            /// <para>
            ///   <see href="https://learn.microsoft.com/windows/win32/api/d2d1_3/nf-d2d1_3-id2d1devicecontext2-creategradientmesh#parameters">Read more on docs.microsoft.com</see>.</para></param>
            /// <returns>
            /// Type: <b><a href="https://learn.microsoft.com/windows/win32/com/structure-of-com-error-codes">HRESULT</a></b> S_OK if successful, otherwise a failure HRESULT.
            /// </returns>
            /// <remarks>
            ///   <see href="https://learn.microsoft.com/windows/win32/api/d2d1_3/nf-d2d1_3-id2d1devicecontext2-creategradientmesh">Learn more about this API from docs.microsoft.com</see>.
            /// </remarks>
            new unsafe void CreateGradientMesh(D2D1_GRADIENT_MESH_PATCH* patches, uint patchesCount, out ID2D1GradientMesh gradientMesh);
            ...
            /// </summary>
            /// <param name="wicBitmapSource"><para>Type: <b><a href="https://learn.microsoft.com/windows/desktop/api/wincodec/nn-wincodec-iwicbitmapsource">IWICBitmapSource</a>*</b> The WIC bitmap source to create the image source from.</para>
            /// <para>
            ///   <see href="https://learn.microsoft.com/windows/win32/api/d2d1_3/nf-d2d1_3-id2d1devicecontext2-createimagesourcefromwic(iwicbitmapsource_id2d1imagesourcefromwic)#parameters">Read more on docs.microsoft.com</see>.</para></param>
            /// <param name="loadingOptions">The loading options.</param>
            /// <param name="alphaMode">The alpha mode.</param>
            /// <param name="imageSource"><para>Type: <b><a href="https://learn.microsoft.com/windows/desktop/api/d2d1_3/nn-d2d1_3-id2d1imagesourcefromwic">ID2D1ImageSourceFromWic</a>**</b> Receives the new image source instance.</para>
            /// <para>
            ///   <see href="https://learn.microsoft.com/windows/win32/api/d2d1_3/nf-d2d1_3-id2d1devicecontext2-createimagesourcefromwic(iwicbitmapsource_id2d1imagesourcefromwic)#parameters">Read more on docs.microsoft.com</see>.</para></param>
            /// <returns>
            /// Type: <b><a href="https://learn.microsoft.com/windows/win32/com/structure-of-com-error-codes">HRESULT</a></b> S_OK if successful, otherwise a failure HRESULT.
            /// </returns>
            /// <remarks>
            /// <para>This method creates an image source which can be used to draw the image. This method supports images that exceed the maximum texture size.  Large images are internally stored within a sparse tile cache. This API supports the same set of pixel formats and alpha modes supported by <a href="https://learn.microsoft.com/windows/desktop/Direct2D/id2d1devicecontext-createbitmapfromwicbitmap-overload">CreateBitmapFromWicBitmap</a>. If the GPU does not support a given pixel format, this method will return D2DERR_UNSUPPORTED_PIXEL_FORMAT.  This method does not apply adjustments such as gamma or alpha premultiplication which affect the appearance of the image.</para>
            ...
            /// <para>
            ///   <see href="https://learn.microsoft.com/windows/win32/api/d2d1_3/nf-d2d1_3-id2d1devicecontext2-createimagesourcefromwic(iwicbitmapsource_id2d1imagesourcefromwic)#">Read more on docs.microsoft.com</see>.</para>
            /// </remarks>
            new void CreateImageSourceFromWic(IWICBitmapSource wicBitmapSource, D2D1_IMAGE_SOURCE_LOADING_OPTIONS loadingOptions, D2D1_ALPHA_MODE alphaMode, out ID2D1ImageSourceFromWic imageSource);
            ...
            /// </summary>
            /// <param name="precision"><para>Type: <b><a href="https://learn.microsoft.com/windows/desktop/api/d2d1_1/ne-d2d1_1-d2d1_buffer_precision">D2D1_BUFFER_PRECISION</a></b> Precision of the input lookup table data.</para>
            /// <para>
            ///   <see href="https://learn.microsoft.com/windows/win32/api/d2d1_3/nf-d2d1_3-id2d1devicecontext2-createlookuptable3d#parameters">Read more on docs.microsoft.com</see>.</para></param>
            /// <param name="extents"><para>Type: <b>const UINT32*</b> Number of lookup table elements per dimension (X, Y, Z).</para>
            /// <para>
            ///   <see href="https://learn.microsoft.com/windows/win32/api/d2d1_3/nf-d2d1_3-id2d1devicecontext2-createlookuptable3d#parameters">Read more on docs.microsoft.com</see>.</para></param>
            /// <param name="data"><para>Type: <b>const BYTE*</b> Buffer holding the lookup table data.</para>
            /// <para>
            ///   <see href="https://learn.microsoft.com/windows/win32/api/d2d1_3/nf-d2d1_3-id2d1devicecontext2-createlookuptable3d#parameters">Read more on docs.microsoft.com</see>.</para></param>
            /// <param name="dataCount"><para>Type: <b>UINT32</b> Size of the lookup table data buffer.</para>
            /// <para>
            ///   <see href="https://learn.microsoft.com/windows/win32/api/d2d1_3/nf-d2d1_3-id2d1devicecontext2-createlookuptable3d#parameters">Read more on docs.microsoft.com</see>.</para></param>
            /// <param name="strides"><para>Type: <b>const UINT32*</b> An array containing two values.  The first value is the size in bytes from one row (X dimension) of LUT data to the next. The second value is the size in bytes from one LUT data plane (X and Y dimensions) to the next.</para>
            /// <para>
            ///   <see href="https://learn.microsoft.com/windows/win32/api/d2d1_3/nf-d2d1_3-id2d1devicecontext2-createlookuptable3d#parameters">Read more on docs.microsoft.com</see>.</para></param>
            /// <param name="lookupTable"><para>Type: <b><a href="https://learn.microsoft.com/windows/desktop/api/d2d1_3/nn-d2d1_3-id2d1lookuptable3d">ID2D1LookupTable3D</a>**</b> Receives the new lookup table instance.</para>
            /// <para>
            ///   <see href="https://learn.microsoft.com/windows/win32/api/d2d1_3/nf-d2d1_3-id2d1devicecontext2-createlookuptable3d#parameters">Read more on docs.microsoft.com</see>.</para></param>
            /// <returns>
            /// Type: <b><a href="https://learn.microsoft.com/windows/win32/com/structure-of-com-error-codes">HRESULT</a></b> S_OK if successful, otherwise a failure HRESULT.
            /// </returns>
            /// <remarks>
            ///   <see href="https://learn.microsoft.com/windows/win32/api/d2d1_3/nf-d2d1_3-id2d1devicecontext2-createlookuptable3d">Learn more about this API from docs.microsoft.com</see>.
            /// </remarks>
            new void CreateLookupTable3D(D2D1_BUFFER_PRECISION precision, [MarshalAs(UnmanagedType.LPArray, SizeConst = 3)] uint[] extents, [MarshalAs(UnmanagedType.LPArray, SizeParamIndex = 3)] byte[] data, uint dataCount, [MarshalAs(UnmanagedType.LPArray, SizeConst = 2)] uint[] strides, out ID2D1LookupTable3D lookupTable);
            ...
            /// </summary>
            /// <param name="surfaces"><para>Type: [in] <b><a href="https://learn.microsoft.com/windows/desktop/api/dxgi/nn-dxgi-idxgisurface">IDXGISurface</a>**</b> The DXGI surfaces to create the image source from.</para>
            /// <para>
            ///   <see href="https://learn.microsoft.com/windows/win32/api/d2d1_3/nf-d2d1_3-id2d1devicecontext2-createimagesourcefromdxgi#parameters">Read more on docs.microsoft.com</see>.</para></param>
            /// <param name="surfaceCount"><para>Type: <b>UINT32</b> The number of surfaces provided; must be between one and three.</para>
            /// <para>
            ///   <see href="https://learn.microsoft.com/windows/win32/api/d2d1_3/nf-d2d1_3-id2d1devicecontext2-createimagesourcefromdxgi#parameters">Read more on docs.microsoft.com</see>.</para></param>
            /// <param name="colorSpace"><para>Type: <b><a href="https://learn.microsoft.com/windows/desktop/api/dxgicommon/ne-dxgicommon-dxgi_color_space_type">DXGI_COLOR_SPACE_TYPE</a></b> The color space of the input.</para>
            /// <para>
            ///   <see href="https://learn.microsoft.com/windows/win32/api/d2d1_3/nf-d2d1_3-id2d1devicecontext2-createimagesourcefromdxgi#parameters">Read more on docs.microsoft.com</see>.</para></param>
            /// <param name="options"><para>Type: <b><a href="https://learn.microsoft.com/windows/desktop/api/d2d1_3/ne-d2d1_3-d2d1_image_source_from_dxgi_options">D2D1_IMAGE_SOURCE_FROM_DXGI_OPTIONS</a></b> Options controlling color space conversions.</para>
            /// <para>
            ///   <see href="https://learn.microsoft.com/windows/win32/api/d2d1_3/nf-d2d1_3-id2d1devicecontext2-createimagesourcefromdxgi#parameters">Read more on docs.microsoft.com</see>.</para></param>
            /// <param name="imageSource"><para>Type: [out] <b><a href="https://learn.microsoft.com/windows/desktop/api/d2d1_3/nn-d2d1_3-id2d1imagesource">ID2D1ImageSource</a>**</b> Receives the new image source instance.</para>
            /// <para>
            ///   <see href="https://learn.microsoft.com/windows/win32/api/d2d1_3/nf-d2d1_3-id2d1devicecontext2-createimagesourcefromdxgi#parameters">Read more on docs.microsoft.com</see>.</para></param>
            /// <returns>
            /// Type: <b><a href="https://learn.microsoft.com/windows/win32/com/structure-of-com-error-codes">HRESULT</a></b> S_OK if successful, otherwise a failure HRESULT.
            /// </returns>
            /// <remarks>
            /// <para>This method creates an image source, which can be used to draw the image. This method supports surfaces that use a limited set of DXGI formats and DXGI color space types.  Only the below set of combinations of color space types, surface formats, and surface counts are supported: </para>
            /// <para>This doc was truncated.</para>
            /// <para>
            ///   <see href="https://learn.microsoft.com/windows/win32/api/d2d1_3/nf-d2d1_3-id2d1devicecontext2-createimagesourcefromdxgi#">Read more on docs.microsoft.com</see>.</para>
            /// </remarks>
            new void CreateImageSourceFromDxgi([MarshalAs(UnmanagedType.LPArray, SizeParamIndex = 1)] IDXGISurface[] surfaces, uint surfaceCount, DXGI_COLOR_SPACE_TYPE colorSpace, D2D1_IMAGE_SOURCE_FROM_DXGI_OPTIONS options, out ID2D1ImageSource imageSource);

            /// <summary>
            /// Returns the world bounds of a given gradient mesh.
            /// </summary>
            /// <param name="gradientMesh"><para>Type: <b><a href="https://learn.microsoft.com/windows/desktop/api/d2d1_3/nn-d2d1_3-id2d1gradientmesh">ID2D1GradientMesh</a>*</b> The gradient mesh whose world bounds will be calculated.</para>
            /// <para>
            ///   <see href="https://learn.microsoft.com/windows/win32/api/d2d1_3/nf-d2d1_3-id2d1devicecontext2-getgradientmeshworldbounds#parameters">Read more on learn.microsoft.com</see>.</para></param>
            /// <param name="pBounds"><para>Type: <b><a href="https://learn.microsoft.com/windows/desktop/Direct2D/d2d1-rect-f">D2D1_RECT_F</a>*</b> When this method returns, contains a pointer to the bounds of the gradient mesh, in device independent pixels (DIPs).</para>
            /// <para>
            ///   <see href="https://learn.microsoft.com/windows/win32/api/d2d1_3/nf-d2d1_3-id2d1devicecontext2-getgradientmeshworldbounds#parameters">Read more on learn.microsoft.com</see>.</para></param>
            /// <returns>
            /// Type: <b><a href="https://learn.microsoft.com/windows/win32/com/structure-of-com-error-codes">HRESULT</a></b> S_OK if successful, otherwise a failure HRESULT.
            /// </returns>
            /// <remarks>
            ///   <see href="https://learn.microsoft.com/windows/win32/api/d2d1_3/nf-d2d1_3-id2d1devicecontext2-getgradientmeshworldbounds">Learn more about this API from learn.microsoft.com</see>.
            /// </remarks>
            new unsafe void GetGradientMeshWorldBounds(ID2D1GradientMesh gradientMesh, D2D_RECT_F* pBounds);

            /// <summary>
            /// Renders the given ink object using the given brush and ink style.
            /// </summary>
            /// <param name="ink"><para>Type: <b><a href="https://learn.microsoft.com/windows/desktop/api/d2d1_3/nn-d2d1_3-id2d1ink">ID2D1Ink</a>*</b> The ink object to be rendered.</para>
            /// <para>
            ///   <see href="https://learn.microsoft.com/windows/win32/api/d2d1_3/nf-d2d1_3-id2d1devicecontext2-drawink#parameters">Read more on learn.microsoft.com</see>.</para></param>
            /// <param name="brush"><para>Type: <b><a href="https://learn.microsoft.com/windows/desktop/api/d2d1/nn-d2d1-id2d1brush">ID2D1Brush</a>*</b> The brush with which to render the ink object.</para>
            /// <para>
            ///   <see href="https://learn.microsoft.com/windows/win32/api/d2d1_3/nf-d2d1_3-id2d1devicecontext2-drawink#parameters">Read more on learn.microsoft.com</see>.</para></param>
            /// <param name="inkStyle"><para>Type: <b><a href="https://learn.microsoft.com/windows/desktop/api/d2d1_3/nn-d2d1_3-id2d1inkstyle">ID2D1InkStyle</a>*</b> The ink style to use when rendering the ink object.</para>
            /// <para>
            ///   <see href="https://learn.microsoft.com/windows/win32/api/d2d1_3/nf-d2d1_3-id2d1devicecontext2-drawink#parameters">Read more on learn.microsoft.com</see>.</para></param>
            /// <remarks>
            ///   <see href="https://learn.microsoft.com/windows/win32/api/d2d1_3/nf-d2d1_3-id2d1devicecontext2-drawink">Learn more about this API from learn.microsoft.com</see>.
            /// </remarks>
            [PreserveSig]
            ...
            /// </summary>
            /// <param name="gradientMesh"><para>Type: <b><a href="https://learn.microsoft.com/windows/desktop/api/d2d1_3/nn-d2d1_3-id2d1gradientmesh">ID2D1GradientMesh</a>*</b> The gradient mesh to be rendered.</para>
            /// <para>
            ///   <see href="https://learn.microsoft.com/windows/win32/api/d2d1_3/nf-d2d1_3-id2d1devicecontext2-drawgradientmesh#parameters">Read more on learn.microsoft.com</see>.</para></param>
            /// <remarks>
            ///   <see href="https://learn.microsoft.com/windows/win32/api/d2d1_3/nf-d2d1_3-id2d1devicecontext2-drawgradientmesh">Learn more about this API from learn.microsoft.com</see>.
            /// </remarks>
            [PreserveSig]
            ...
            /// <param name="gdiMetafile"><para>Type: <b><a href="https://learn.microsoft.com/windows/desktop/api/d2d1_1/nn-d2d1_1-id2d1gdimetafile">ID2D1GdiMetafile</a>*</b> The metafile to draw.</para>
            /// <para>
            ///   <see href="https://learn.microsoft.com/windows/win32/api/d2d1_3/nf-d2d1_3-id2d1devicecontext2-drawgdimetafile(id2d1gdimetafile_constd2d1_rect_f__constd2d1_rect_f)#parameters">Read more on docs.microsoft.com</see>.</para></param>
            /// <param name="destinationRectangle"><para>Type: <b>const <a href="https://learn.microsoft.com/windows/desktop/Direct2D/d2d1-rect-f">D2D1_RECT_F</a>*</b> The rectangle in the target where the metafile will be drawn, relative to the upper left corner (defined in DIPs) of the render target. If NULL is specified, the destination rectangle is {0, 0, w, h}, where w and h are the width and height of the metafile as reported by <a href="https://learn.microsoft.com/windows/desktop/api/d2d1_1/nf-d2d1_1-id2d1gdimetafile-getbounds">ID2D1GdiMetafile::GetBounds</a>.</para>
            /// <para>
            ///   <see href="https://learn.microsoft.com/windows/win32/api/d2d1_3/nf-d2d1_3-id2d1devicecontext2-drawgdimetafile(id2d1gdimetafile_constd2d1_rect_f__constd2d1_rect_f)#parameters">Read more on docs.microsoft.com</see>.</para></param>
            /// <param name="sourceRectangle"><para>Type: <b>const <a href="https://learn.microsoft.com/windows/desktop/Direct2D/d2d1-rect-f">D2D1_RECT_F</a>*</b> The rectangle of the source metafile that will be drawn, relative to the upper left corner (defined in DIPs) of the metafile. If NULL is specified, the source rectangle is the value returned by <a href="https://learn.microsoft.com/windows/desktop/api/d2d1_3/nf-d2d1_3-id2d1gdimetafile1-getsourcebounds">ID2D1GdiMetafile1::GetSourceBounds</a>.</para>
            /// <para>
            ///   <see href="https://learn.microsoft.com/windows/win32/api/d2d1_3/nf-d2d1_3-id2d1devicecontext2-drawgdimetafile(id2d1gdimetafile_constd2d1_rect_f__constd2d1_rect_f)#parameters">Read more on docs.microsoft.com</see>.</para></param>
            /// <remarks>
            ///   <see href="https://learn.microsoft.com/windows/win32/api/d2d1_3/nf-d2d1_3-id2d1devicecontext2-drawgdimetafile(id2d1gdimetafile_constd2d1_rect_f__constd2d1_rect_f)">Learn more about this API from docs.microsoft.com</see>.
            /// </remarks>
            [PreserveSig]
            new unsafe void DrawGdiMetafile(ID2D1GdiMetafile gdiMetafile, [Optional] D2D_RECT_F* destinationRectangle, [Optional] D2D_RECT_F* sourceRectangle);

            /// <summary>
            /// Creates an image source which shares resources with an original.
            /// </summary>
            /// <param name="imageSource"><para>Type: <b><a href="https://learn.microsoft.com/windows/desktop/api/d2d1_3/nn-d2d1_3-id2d1imagesource">ID2D1ImageSource</a>*</b> The original image.</para>
            /// <para>
            ///   <see href="https://learn.microsoft.com/windows/win32/api/d2d1_3/nf-d2d1_3-id2d1devicecontext2-createtransformedimagesource#parameters">Read more on learn.microsoft.com</see>.</para></param>
            /// <param name="properties"><para>Type: <b>const <a href="https://learn.microsoft.com/windows/desktop/api/d2d1_3/ns-d2d1_3-d2d1_transformed_image_source_properties">D2D1_TRANSFORMED_IMAGE_SOURCE_PROPERTIES</a>*</b> Properties for the source image.</para>
            /// <para>
            ///   <see href="https://learn.microsoft.com/windows/win32/api/d2d1_3/nf-d2d1_3-id2d1devicecontext2-createtransformedimagesource#parameters">Read more on learn.microsoft.com</see>.</para></param>
            /// <param name="transformedImageSource"><para>Type: <b><a href="https://learn.microsoft.com/windows/desktop/api/d2d1_3/nn-d2d1_3-id2d1transformedimagesource">ID2D1TransformedImageSource</a>**</b> Receives the new image source.</para>
            /// <para>
            ///   <see href="https://learn.microsoft.com/windows/win32/api/d2d1_3/nf-d2d1_3-id2d1devicecontext2-createtransformedimagesource#parameters">Read more on learn.microsoft.com</see>.</para></param>
            /// <returns>
            /// Type: <b><a href="https://learn.microsoft.com/windows/win32/com/structure-of-com-error-codes">HRESULT</a></b> If this method succeeds, it returns <b xmlns:loc="http://microsoft.com/wdcml/l10n">S_OK</b>. Otherwise, it returns an <b xmlns:loc="http://microsoft.com/wdcml/l10n">HRESULT</b> error code.
            /// </returns>
            /// <remarks>
            ///   <see href="https://learn.microsoft.com/windows/win32/api/d2d1_3/nf-d2d1_3-id2d1devicecontext2-createtransformedimagesource">Learn more about this API from learn.microsoft.com</see>.
            /// </remarks>
            ...
            /// </summary>
            /// <param name="spriteBatch"><para>Type: <b><a href="https://learn.microsoft.com/windows/desktop/api/d2d1_3/nn-d2d1_3-id2d1spritebatch">ID2D1SpriteBatch</a>**</b> When this method returns, contains a pointer to a new, empty sprite batch to be populated by the app.</para>
            /// <para>
            ///   <see href="https://learn.microsoft.com/windows/win32/api/d2d1_3/nf-d2d1_3-id2d1devicecontext3-createspritebatch#parameters">Read more on docs.microsoft.com</see>.</para></param>
            /// <returns>
            /// Type: <b><a href="https://learn.microsoft.com/windows/win32/com/structure-of-com-error-codes">HRESULT</a></b> If this method succeeds, it returns <b>S_OK</b>. Otherwise, it returns an <b>HRESULT</b> error code.
            /// </returns>
            /// <remarks>
            ///   <see href="https://learn.microsoft.com/windows/win32/api/d2d1_3/nf-d2d1_3-id2d1devicecontext3-createspritebatch">Learn more about this API from docs.microsoft.com</see>.
            /// </remarks>
            ...
            /// </summary>
            /// <param name="spriteBatch"><para>Type: <b><a href="https://learn.microsoft.com/windows/desktop/api/d2d1_3/nn-d2d1_3-id2d1spritebatch">ID2D1SpriteBatch</a>*</b> The sprite batch to draw.</para>
            /// <para>
            ///   <see href="https://learn.microsoft.com/windows/win32/api/d2d1_3/nf-d2d1_3-id2d1devicecontext3-drawspritebatch(id2d1spritebatch_id2d1bitmap_d2d1_bitmap_interpolation_mode_d2d1_sprite_options)#parameters">Read more on docs.microsoft.com</see>.</para></param>
            /// <param name="startIndex">The start index.</param>
            /// <param name="spriteCount">The sprite count.</param>
            /// <param name="bitmap"><para>Type: <b><a href="https://learn.microsoft.com/windows/desktop/api/d2d1/nn-d2d1-id2d1bitmap">ID2D1Bitmap</a>*</b> The bitmap from which the sprites are to be sourced. Each sprite’s source rectangle refers to a portion of this bitmap.</para>
            /// <para>
            ///   <see href="https://learn.microsoft.com/windows/win32/api/d2d1_3/nf-d2d1_3-id2d1devicecontext3-drawspritebatch(id2d1spritebatch_id2d1bitmap_d2d1_bitmap_interpolation_mode_d2d1_sprite_options)#parameters">Read more on docs.microsoft.com</see>.</para></param>
            /// <param name="interpolationMode"><para>Type: <b><a href="https://learn.microsoft.com/windows/desktop/api/d2d1/ne-d2d1-d2d1_bitmap_interpolation_mode">D2D1_BITMAP_INTERPOLATION_MODE</a></b> The interpolation mode to use when drawing this sprite batch. This determines how Direct2D interpolates pixels within the drawn sprites if scaling is performed.</para>
            /// <para>
            ///   <see href="https://learn.microsoft.com/windows/win32/api/d2d1_3/nf-d2d1_3-id2d1devicecontext3-drawspritebatch(id2d1spritebatch_id2d1bitmap_d2d1_bitmap_interpolation_mode_d2d1_sprite_options)#parameters">Read more on docs.microsoft.com</see>.</para></param>
            /// <param name="spriteOptions"><para>Type: <b><a href="https://learn.microsoft.com/windows/desktop/api/d2d1_3/ne-d2d1_3-d2d1_sprite_options">D2D1_SPRITE_OPTIONS</a></b> The additional drawing options, if any, to be used for this sprite batch.</para>
            /// <para>
            ///   <see href="https://learn.microsoft.com/windows/win32/api/d2d1_3/nf-d2d1_3-id2d1devicecontext3-drawspritebatch(id2d1spritebatch_id2d1bitmap_d2d1_bitmap_interpolation_mode_d2d1_sprite_options)#parameters">Read more on docs.microsoft.com</see>.</para></param>
            /// <remarks>
            ///   <see href="https://learn.microsoft.com/windows/win32/api/d2d1_3/nf-d2d1_3-id2d1devicecontext3-drawspritebatch(id2d1spritebatch_id2d1bitmap_d2d1_bitmap_interpolation_mode_d2d1_sprite_options)">Learn more about this API from docs.microsoft.com</see>.
            /// </remarks>
            [PreserveSig]
            ...
            /// <para>Type: <b><a href="https://learn.microsoft.com/windows/desktop/api/d2d1_3/nn-d2d1_3-id2d1svgglyphstyle">ID2D1SvgGlyphStyle</a>**</b> On completion points to the created <a href="https://learn.microsoft.com/windows/desktop/api/d2d1_3/nn-d2d1_3-id2d1svgglyphstyle">ID2D1SvgGlyphStyle</a> object.</para>
            /// <para><see href="https://learn.microsoft.com/windows/win32/api/d2d1_3/nf-d2d1_3-id2d1devicecontext4-createsvgglyphstyle#parameters">Read more on docs.microsoft.com</see>.</para>
            /// </param>
            /// <returns>
            /// <para>Type: <b><a href="https://learn.microsoft.com/windows/win32/com/structure-of-com-error-codes">HRESULT</a></b> This method returns an HRESULT success or error code.</para>
            /// </returns>
            /// <remarks>
            /// <para><see href="https://learn.microsoft.com/windows/win32/api/d2d1_3/nf-d2d1_3-id2d1devicecontext4-createsvgglyphstyle">Learn more about this API from docs.microsoft.com</see>.</para>
            /// </remarks>
            ...
            /// <para>
            ///   <see href="https://learn.microsoft.com/windows/win32/api/d2d1_3/nf-d2d1_3-id2d1devicecontext4-drawtext(constwchar_uint32_idwritetextformat_constd2d1_rect_f__id2d1brush_id2d1svgglyphstyle_uint32_d2d1_draw_text_options_dwrite_measuring_mode)#parameters">Read more on docs.microsoft.com</see>.</para></param>
            /// <param name="svgGlyphStyle"><para>Type: <b><a href="https://learn.microsoft.com/windows/desktop/api/d2d1_3/nn-d2d1_3-id2d1svgglyphstyle">ID2D1SvgGlyphStyle</a>*</b> Values for context-fill, context-stroke, and context-value that are used when rendering SVG glyphs.</para>
            /// <para>
            ///   <see href="https://learn.microsoft.com/windows/win32/api/d2d1_3/nf-d2d1_3-id2d1devicecontext4-drawtext(constwchar_uint32_idwritetextformat_constd2d1_rect_f__id2d1brush_id2d1svgglyphstyle_uint32_d2d1_draw_text_options_dwrite_measuring_mode)#parameters">Read more on docs.microsoft.com</see>.</para></param>
            /// <param name="colorPaletteIndex"><para>Type: <b>UINT32</b> The index used to select a color palette within a color font.</para>
            /// <para>
            ///   <see href="https://learn.microsoft.com/windows/win32/api/d2d1_3/nf-d2d1_3-id2d1devicecontext4-drawtext(constwchar_uint32_idwritetextformat_constd2d1_rect_f__id2d1brush_id2d1svgglyphstyle_uint32_d2d1_draw_text_options_dwrite_measuring_mode)#parameters">Read more on docs.microsoft.com</see>.</para></param>
            /// <param name="options"><para>Type: <b><a href="https://learn.microsoft.com/windows/desktop/api/d2d1/ne-d2d1-d2d1_draw_text_options">D2D1_DRAW_TEXT_OPTIONS</a></b> A value that indicates whether the text should be snapped to pixel boundaries and whether the text should be clipped to the layout rectangle. The default value is <a href="https://learn.microsoft.com/windows/desktop/api/d2d1/ne-d2d1-d2d1_draw_text_options">D2D1_DRAW_TEXT_OPTIONS_NONE</a>, which indicates that text should be snapped to pixel boundaries and it should not be clipped to the layout rectangle.</para>
            /// <para>
            ...
            /// </remarks>
            [PreserveSig]
            new unsafe void DrawText(PCWSTR @string, uint stringLength, IDWriteTextFormat textFormat, D2D_RECT_F* layoutRect, ID2D1Brush defaultFillBrush, ID2D1SvgGlyphStyle svgGlyphStyle, uint colorPaletteIndex, D2D1_DRAW_TEXT_OPTIONS options, DWRITE_MEASURING_MODE measuringMode);
            ...
            /// </summary>
            /// <param name="origin"><para>Type: <b><a href="https://learn.microsoft.com/windows/desktop/Direct2D/d2d1-point-2f">D2D1_POINT_2F</a></b> The point, described in device-independent pixels, at which the upper-left corner of the text described by <i>textLayout</i> is drawn.</para>
            /// <para>
            ///   <see href="https://learn.microsoft.com/windows/win32/api/d2d1_3/nf-d2d1_3-id2d1devicecontext4-drawtextlayout#parameters">Read more on learn.microsoft.com</see>.</para></param>
            /// <param name="textLayout"><para>Type: <b><a href="https://learn.microsoft.com/windows/desktop/api/dwrite/nn-dwrite-idwritetextlayout">IDWriteTextLayout</a>*</b> The formatted text to draw. Any drawing effects that do not inherit from <a href="https://learn.microsoft.com/windows/desktop/api/d2d1/nn-d2d1-id2d1resource">ID2D1Resource</a> are ignored. If there are drawing effects that inherit from <b>ID2D1Resource</b> that are not brushes, this method fails and the render target is put in an error state.</para>
            /// <para>
            ///   <see href="https://learn.microsoft.com/windows/win32/api/d2d1_3/nf-d2d1_3-id2d1devicecontext4-drawtextlayout#parameters">Read more on learn.microsoft.com</see>.</para></param>
            /// <param name="defaultFillBrush"><para>Type: <b><a href="https://learn.microsoft.com/windows/desktop/api/d2d1/nn-d2d1-id2d1brush">ID2D1Brush</a>*</b> The brush used to paint the text.</para>
            /// <para>
            ///   <see href="https://learn.microsoft.com/windows/win32/api/d2d1_3/nf-d2d1_3-id2d1devicecontext4-drawtextlayout#parameters">Read more on learn.microsoft.com</see>.</para></param>
            /// <param name="svgGlyphStyle"><para>Type: <b><a href="https://learn.microsoft.com/windows/desktop/api/d2d1_3/nn-d2d1_3-id2d1svgglyphstyle">ID2D1SvgGlyphStyle</a>*</b> The values for context-fill, context-stroke, and context-value that are used when rendering SVG glyphs.</para>
            /// <para>
            ///   <see href="https://learn.microsoft.com/windows/win32/api/d2d1_3/nf-d2d1_3-id2d1devicecontext4-drawtextlayout#parameters">Read more on learn.microsoft.com</see>.</para></param>
            /// <param name="colorPaletteIndex"><para>Type: <b>UINT32</b> The index used to select a color palette within a color font.</para>
            /// <para>
            ...
            ///   <see href="https://learn.microsoft.com/windows/win32/api/d2d1_3/nf-d2d1_3-id2d1devicecontext4-drawtextlayout#parameters">Read more on learn.microsoft.com</see>.</para></param>
            /// <remarks>
            ///   <see href="https://learn.microsoft.com/windows/win32/api/d2d1_3/nf-d2d1_3-id2d1devicecontext4-drawtextlayout">Learn more about this API from learn.microsoft.com</see>.
            /// </remarks>
            [PreserveSig]
            new void DrawTextLayout(D2D_POINT_2F origin, IDWriteTextLayout textLayout, ID2D1Brush defaultFillBrush, ID2D1SvgGlyphStyle svgGlyphStyle, uint colorPaletteIndex, D2D1_DRAW_TEXT_OPTIONS options);

            /// <summary>
            /// Draws a color bitmap glyph run using one of the bitmap formats.
            /// </summary>
            /// <param name="glyphImageFormat"><para>Type: <b><a href="https://learn.microsoft.com/windows/desktop/api/dcommon/ne-dcommon-dwrite_glyph_image_formats">DWRITE_GLYPH_IMAGE_FORMATS</a></b> Specifies the format of the glyph image. Supported formats are DWRITE_GLYPH_IMAGE_FORMATS_PNG, DWRITE_GLYPH_IMAGE_FORMATS_JPEG, DWRITE_GLYPH_IMAGE_FORMATS_TIFF, or DWRITE_GLYPH_IMAGE_FORMATS_PREMULTIPLIED_B8G8R8A8.  This method will result in an error if the color glyph run does not contain the requested format.</para>
            /// <para>Only one format can be specified at a time, combinations of flags are not valid input.</para>
            /// <para>
            ///   <see href="https://learn.microsoft.com/windows/win32/api/d2d1_3/nf-d2d1_3-id2d1devicecontext4-drawcolorbitmapglyphrun#parameters">Read more on learn.microsoft.com</see>.</para></param>
            /// <param name="baselineOrigin"><para>Type: <b><a href="https://learn.microsoft.com/windows/desktop/Direct2D/d2d1-point-2f">D2D1_POINT_2F</a></b> The origin of the baseline for the glyph run.</para>
            /// <para>
            ///   <see href="https://learn.microsoft.com/windows/win32/api/d2d1_3/nf-d2d1_3-id2d1devicecontext4-drawcolorbitmapglyphrun#parameters">Read more on learn.microsoft.com</see>.</para></param>
            /// <param name="glyphRun"><para>Type: <b>const <a href="https://learn.microsoft.com/windows/desktop/api/dwrite/ns-dwrite-dwrite_glyph_run">DWRITE_GLYPH_RUN</a>*</b> The glyphs to render.</para>
            /// <para>
            ///   <see href="https://learn.microsoft.com/windows/win32/api/d2d1_3/nf-d2d1_3-id2d1devicecontext4-drawcolorbitmapglyphrun#parameters">Read more on learn.microsoft.com</see>.</para></param>
            /// <param name="measuringMode"><para>Type: <b><a href="https://learn.microsoft.com/windows/desktop/api/dcommon/ne-dcommon-dwrite_measuring_mode">DWRITE_MEASURING_MODE</a></b> Indicates the measuring method.</para>
            /// <para>
            ///   <see href="https://learn.microsoft.com/windows/win32/api/d2d1_3/nf-d2d1_3-id2d1devicecontext4-drawcolorbitmapglyphrun#parameters">Read more on learn.microsoft.com</see>.</para></param>
            /// <param name="bitmapSnapOption"><para>Type: <b><a href="https://learn.microsoft.com/windows/desktop/api/d2d1_3/ne-d2d1_3-d2d1_color_bitmap_glyph_snap_option">D2D1_COLOR_BITMAP_GLYPH_SNAP_OPTION</a></b> Specifies the pixel snapping policy when rendering color bitmap glyphs.</para>
            /// <para>
            ///   <see href="https://learn.microsoft.com/windows/win32/api/d2d1_3/nf-d2d1_3-id2d1devicecontext4-drawcolorbitmapglyphrun#parameters">Read more on learn.microsoft.com</see>.</para></param>
            /// <remarks>
            ///   <see href="https://learn.microsoft.com/windows/win32/api/d2d1_3/nf-d2d1_3-id2d1devicecontext4-drawcolorbitmapglyphrun">Learn more about this API from learn.microsoft.com</see>.
            /// </remarks>
            [PreserveSig]
            new void DrawColorBitmapGlyphRun(DWRITE_GLYPH_IMAGE_FORMATS glyphImageFormat, D2D_POINT_2F baselineOrigin, in DWRITE_GLYPH_RUN glyphRun, DWRITE_MEASURING_MODE measuringMode, D2D1_COLOR_BITMAP_GLYPH_SNAP_OPTION bitmapSnapOption);
            ...
            /// <param name="baselineOrigin"><para>Type: <b><a href="https://learn.microsoft.com/windows/desktop/Direct2D/d2d1-point-2f">D2D1_POINT_2F</a></b> The origin of the baseline for the glyph run.</para>
            /// <para>
            ///   <see href="https://learn.microsoft.com/windows/win32/api/d2d1_3/nf-d2d1_3-id2d1devicecontext4-drawsvgglyphrun#parameters">Read more on learn.microsoft.com</see>.</para></param>
            /// <param name="glyphRun"><para>Type: <b>const <a href="https://learn.microsoft.com/windows/desktop/api/dwrite/ns-dwrite-dwrite_glyph_run">DWRITE_GLYPH_RUN</a>*</b> The glyphs to render.</para>
            /// <para>
            ///   <see href="https://learn.microsoft.com/windows/win32/api/d2d1_3/nf-d2d1_3-id2d1devicecontext4-drawsvgglyphrun#parameters">Read more on learn.microsoft.com</see>.</para></param>
            /// <param name="defaultFillBrush"><para>Type: <b><a href="https://learn.microsoft.com/windows/desktop/api/d2d1/nn-d2d1-id2d1brush">ID2D1Brush</a>*</b> The brush used to paint the specified glyphs.</para>
            /// <para>
            ///   <see href="https://learn.microsoft.com/windows/win32/api/d2d1_3/nf-d2d1_3-id2d1devicecontext4-drawsvgglyphrun#parameters">Read more on learn.microsoft.com</see>.</para></param>
            /// <param name="svgGlyphStyle"><para>Type: <b><a href="https://learn.microsoft.com/windows/desktop/api/d2d1_3/nn-d2d1_3-id2d1svgglyphstyle">ID2D1SvgGlyphStyle</a>*</b> Values for context-fill, context-stroke, and context-value that are used when rendering SVG glyphs.</para>
            /// <para>
            ///   <see href="https://learn.microsoft.com/windows/win32/api/d2d1_3/nf-d2d1_3-id2d1devicecontext4-drawsvgglyphrun#parameters">Read more on learn.microsoft.com</see>.</para></param>
            /// <param name="colorPaletteIndex"><para>Type: <b>UINT32</b> The index used to select a color palette within a color font. Note that this not the same as the paletteIndex in the DWRITE_COLOR_GLYPH_RUN struct, which is not relevant for SVG glyphs.</para>
            /// <para>
            ///   <see href="https://learn.microsoft.com/windows/win32/api/d2d1_3/nf-d2d1_3-id2d1devicecontext4-drawsvgglyphrun#parameters">Read more on learn.microsoft.com</see>.</para></param>
            /// <param name="measuringMode"><para>Type: <b><a href="https://learn.microsoft.com/windows/desktop/api/dcommon/ne-dcommon-dwrite_measuring_mode">DWRITE_MEASURING_MODE</a></b> Indicates the measuring method used for text layout.</para>
            /// <para>
            ///   <see href="https://learn.microsoft.com/windows/win32/api/d2d1_3/nf-d2d1_3-id2d1devicecontext4-drawsvgglyphrun#parameters">Read more on learn.microsoft.com</see>.</para></param>
            /// <remarks>
            ///   <see href="https://learn.microsoft.com/windows/win32/api/d2d1_3/nf-d2d1_3-id2d1devicecontext4-drawsvgglyphrun">Learn more about this API from learn.microsoft.com</see>.
            /// </remarks>
            [PreserveSig]
            new void DrawSvgGlyphRun(D2D_POINT_2F baselineOrigin, in DWRITE_GLYPH_RUN glyphRun, ID2D1Brush defaultFillBrush, ID2D1SvgGlyphStyle svgGlyphStyle, uint colorPaletteIndex, DWRITE_MEASURING_MODE measuringMode);

            /// <summary>
            /// Retrieves an image of the color bitmap glyph from the color glyph cache.
            /// </summary>
            /// <param name="glyphImageFormat"><para>Type: <b><a href="https://learn.microsoft.com/windows/desktop/api/dcommon/ne-dcommon-dwrite_glyph_image_formats">DWRITE_GLYPH_IMAGE_FORMATS</a></b> The format for the glyph image. If there is no image data in the requested format for the requested glyph, this method will return an error.</para>
            /// <para>
            ///   <see href="https://learn.microsoft.com/windows/win32/api/d2d1_3/nf-d2d1_3-id2d1devicecontext4-getcolorbitmapglyphimage#parameters">Read more on learn.microsoft.com</see>.</para></param>
            /// <param name="glyphOrigin"><para>Type: <b><a href="https://learn.microsoft.com/windows/desktop/Direct2D/d2d1-point-2f">D2D1_POINT_2F</a></b> The origin for the glyph.</para>
            /// <para>
            ///   <see href="https://learn.microsoft.com/windows/win32/api/d2d1_3/nf-d2d1_3-id2d1devicecontext4-getcolorbitmapglyphimage#parameters">Read more on learn.microsoft.com</see>.</para></param>
            /// <param name="fontFace"><para>Type: <b><a href="https://learn.microsoft.com/windows/desktop/api/dwrite/nn-dwrite-idwritefontface">IDWriteFontFace</a>*</b> Reference to a font face which contains font face type, appropriate file references, face identification data and various font data such as metrics, names and glyph outlines.</para>
            /// <para>
            ///   <see href="https://learn.microsoft.com/windows/win32/api/d2d1_3/nf-d2d1_3-id2d1devicecontext4-getcolorbitmapglyphimage#parameters">Read more on learn.microsoft.com</see>.</para></param>
            /// <param name="fontEmSize"><para>Type: <b>FLOAT</b> The specified font size affects the choice of which bitmap to use from the font. It also affects the output glyphTransform, causing  it to properly scale the glyph.</para>
            /// <para>
            ///   <see href="https://learn.microsoft.com/windows/win32/api/d2d1_3/nf-d2d1_3-id2d1devicecontext4-getcolorbitmapglyphimage#parameters">Read more on learn.microsoft.com</see>.</para></param>
            /// <param name="glyphIndex"><para>Type: <b>UINT16</b> Index of the glyph.</para>
            /// <para>
            ///   <see href="https://learn.microsoft.com/windows/win32/api/d2d1_3/nf-d2d1_3-id2d1devicecontext4-getcolorbitmapglyphimage#parameters">Read more on learn.microsoft.com</see>.</para></param>
            /// <param name="isSideways"><para>Type: <b>BOOL</b> If true, specifies that glyphs are rotated 90 degrees to the left and vertical metrics are used. Vertical writing is achieved by specifying isSideways as true and rotating the entire run 90 degrees to the right via a rotate transform.</para>
            /// <para>
            ///   <see href="https://learn.microsoft.com/windows/win32/api/d2d1_3/nf-d2d1_3-id2d1devicecontext4-getcolorbitmapglyphimage#parameters">Read more on learn.microsoft.com</see>.</para></param>
            /// <param name="worldTransform"><para>Type: <b>const <a href="https://learn.microsoft.com/windows/desktop/Direct2D/d2d1-matrix-3x2-f">D2D1_MATRIX_3X2_F</a>*</b> The transform to apply to the image. This input transform affects the choice of which bitmap to use from the font. It is also factored into the output glyphTransform.</para>
            /// <para>
            ///   <see href="https://learn.microsoft.com/windows/win32/api/d2d1_3/nf-d2d1_3-id2d1devicecontext4-getcolorbitmapglyphimage#parameters">Read more on learn.microsoft.com</see>.</para></param>
            /// <param name="dpiX"><para>Type: <b>FLOAT</b> Dots per inch along the x-axis.</para>
            /// <para>
            ///   <see href="https://learn.microsoft.com/windows/win32/api/d2d1_3/nf-d2d1_3-id2d1devicecontext4-getcolorbitmapglyphimage#parameters">Read more on learn.microsoft.com</see>.</para></param>
            /// <param name="dpiY"><para>Type: <b>FLOAT</b> Dots per inch along the y-axis.</para>
            /// <para>
            ///   <see href="https://learn.microsoft.com/windows/win32/api/d2d1_3/nf-d2d1_3-id2d1devicecontext4-getcolorbitmapglyphimage#parameters">Read more on learn.microsoft.com</see>.</para></param>
            /// <param name="glyphTransform"><para>Type: <b><a href="https://learn.microsoft.com/windows/desktop/Direct2D/d2d1-matrix-3x2-f">D2D1_MATRIX_3X2_F</a>*</b> Output transform, which transforms from the glyph's space to the same output space as the worldTransform. This includes the input glyphOrigin, the glyph's offset from the glyphOrigin, and any other required transformations.</para>
            /// <para>
            ///   <see href="https://learn.microsoft.com/windows/win32/api/d2d1_3/nf-d2d1_3-id2d1devicecontext4-getcolorbitmapglyphimage#parameters">Read more on learn.microsoft.com</see>.</para></param>
            /// <param name="glyphImage"><para>Type: <b><a href="https://learn.microsoft.com/windows/desktop/api/d2d1/nn-d2d1-id2d1image">ID2D1Image</a>**</b> On completion contains the retrieved glyph image.</para>
            /// <para>
            ///   <see href="https://learn.microsoft.com/windows/win32/api/d2d1_3/nf-d2d1_3-id2d1devicecontext4-getcolorbitmapglyphimage#parameters">Read more on learn.microsoft.com</see>.</para></param>
            /// <returns>
            /// Type: <b><a href="https://learn.microsoft.com/windows/win32/com/structure-of-com-error-codes">HRESULT</a></b> This method returns an HRESULT success or error code.
            /// </returns>
            /// <remarks>
            ///   <see href="https://learn.microsoft.com/windows/win32/api/d2d1_3/nf-d2d1_3-id2d1devicecontext4-getcolorbitmapglyphimage">Learn more about this API from learn.microsoft.com</see>.
            /// </remarks>
            new unsafe void GetColorBitmapGlyphImage(DWRITE_GLYPH_IMAGE_FORMATS glyphImageFormat, D2D_POINT_2F glyphOrigin, IDWriteFontFace fontFace, float fontEmSize, ushort glyphIndex, BOOL isSideways, [Optional] D2D_MATRIX_3X2_F* worldTransform, float dpiX, float dpiY, D2D_MATRIX_3X2_F* glyphTransform, out ID2D1Image glyphImage);

            /// <summary>
            /// Retrieves an image of the SVG glyph from the color glyph cache.
            /// </summary>
            /// <param name="glyphOrigin"><para>Type: <b><a href="https://learn.microsoft.com/windows/desktop/Direct2D/d2d1-point-2f">D2D1_POINT_2F</a></b> Origin of the glyph.</para>
            /// <para>
            ///   <see href="https://learn.microsoft.com/windows/win32/api/d2d1_3/nf-d2d1_3-id2d1devicecontext4-getsvgglyphimage#parameters">Read more on learn.microsoft.com</see>.</para></param>
            /// <param name="fontFace"><para>Type: <b><a href="https://learn.microsoft.com/windows/desktop/api/dwrite/nn-dwrite-idwritefontface">IDWriteFontFace</a>*</b> Reference to a font face which contains font face type, appropriate file references, face identification data and various font data such as metrics, names and glyph outlines.</para>
            /// <para>
            ///   <see href="https://learn.microsoft.com/windows/win32/api/d2d1_3/nf-d2d1_3-id2d1devicecontext4-getsvgglyphimage#parameters">Read more on learn.microsoft.com</see>.</para></param>
            /// <param name="fontEmSize"><para>Type: <b>FLOAT</b> The specified font size affects the output glyphTransform, causing it to properly scale the glyph.</para>
            /// <para>
            ///   <see href="https://learn.microsoft.com/windows/win32/api/d2d1_3/nf-d2d1_3-id2d1devicecontext4-getsvgglyphimage#parameters">Read more on learn.microsoft.com</see>.</para></param>
            /// <param name="glyphIndex"><para>Type: <b>UINT16</b> Index of the glyph to retrieve.</para>
            /// <para>
            ///   <see href="https://learn.microsoft.com/windows/win32/api/d2d1_3/nf-d2d1_3-id2d1devicecontext4-getsvgglyphimage#parameters">Read more on learn.microsoft.com</see>.</para></param>
            /// <param name="isSideways"><para>Type: <b>BOOL</b> If true, specifies that glyphs are rotated 90 degrees to the left and vertical metrics are used. Vertical writing is achieved by specifying isSideways as true and rotating the entire run 90 degrees to the right via a rotate transform.</para>
            /// <para>
            ///   <see href="https://learn.microsoft.com/windows/win32/api/d2d1_3/nf-d2d1_3-id2d1devicecontext4-getsvgglyphimage#parameters">Read more on learn.microsoft.com</see>.</para></param>
            /// <param name="worldTransform"><para>Type: <b>const <a href="https://learn.microsoft.com/windows/desktop/Direct2D/d2d1-matrix-3x2-f">D2D1_MATRIX_3X2_F</a>*</b> The transform to apply to the image.</para>
            /// <para>
            ///   <see href="https://learn.microsoft.com/windows/win32/api/d2d1_3/nf-d2d1_3-id2d1devicecontext4-getsvgglyphimage#parameters">Read more on learn.microsoft.com</see>.</para></param>
            /// <param name="defaultFillBrush"><para>Type: <b><a href="https://learn.microsoft.com/windows/desktop/api/d2d1/nn-d2d1-id2d1brush">ID2D1Brush</a>*</b> Describes how the area is painted.</para>
            /// <para>
            ///   <see href="https://learn.microsoft.com/windows/win32/api/d2d1_3/nf-d2d1_3-id2d1devicecontext4-getsvgglyphimage#parameters">Read more on learn.microsoft.com</see>.</para></param>
            /// <param name="svgGlyphStyle"><para>Type: <b><a href="https://learn.microsoft.com/windows/desktop/api/d2d1_3/nn-d2d1_3-id2d1svgglyphstyle">ID2D1SvgGlyphStyle</a>*</b> The values for context-fill, context-stroke, and context-value that are used when rendering SVG glyphs.</para>
            /// <para>
            ...
            /// <para>
            ///   <see href="https://learn.microsoft.com/windows/win32/api/d2d1_3/nf-d2d1_3-id2d1devicecontext4-getsvgglyphimage#parameters">Read more on learn.microsoft.com</see>.</para></param>
            /// <param name="glyphImage"><para>Type: <b><a href="https://learn.microsoft.com/windows/desktop/api/d2d1_1/nn-d2d1_1-id2d1commandlist">ID2D1CommandList</a>**</b> On completion, contains the retrieved glyph image.</para>
            /// <para>
            ///   <see href="https://learn.microsoft.com/windows/win32/api/d2d1_3/nf-d2d1_3-id2d1devicecontext4-getsvgglyphimage#parameters">Read more on learn.microsoft.com</see>.</para></param>
            /// <returns>
            /// Type: <b><a href="https://learn.microsoft.com/windows/win32/com/structure-of-com-error-codes">HRESULT</a></b> This method returns an HRESULT success or error code.
            /// </returns>
            /// <remarks>
            ///   <see href="https://learn.microsoft.com/windows/win32/api/d2d1_3/nf-d2d1_3-id2d1devicecontext4-getsvgglyphimage">Learn more about this API from learn.microsoft.com</see>.
            /// </remarks>
            ...
            /// </summary>
            /// <param name="inputXmlStream"><para>Type: <b>IStream*</b> An input stream containing the SVG XML document. If null, an empty document is created.</para>
            /// <para>
            ///   <see href="https://learn.microsoft.com/windows/win32/api/d2d1_3/nf-d2d1_3-id2d1devicecontext5-createsvgdocument#parameters">Read more on learn.microsoft.com</see>.</para></param>
            /// <param name="viewportSize"><para>Type: <b>D2D1_SIZE_F</b> Size of the initial viewport of the document.</para>
            /// <para>
            ///   <see href="https://learn.microsoft.com/windows/win32/api/d2d1_3/nf-d2d1_3-id2d1devicecontext5-createsvgdocument#parameters">Read more on learn.microsoft.com</see>.</para></param>
            /// <param name="svgDocument"><para>Type: <b>ID2D1SvgDocument**</b> When this method returns, contains a pointer to the created SVG document.</para>
            /// <para>
            ///   <see href="https://learn.microsoft.com/windows/win32/api/d2d1_3/nf-d2d1_3-id2d1devicecontext5-createsvgdocument#parameters">Read more on learn.microsoft.com</see>.</para></param>
            /// <returns>
            /// Type: <b><a href="https://learn.microsoft.com/windows/win32/com/structure-of-com-error-codes">HRESULT</a></b> This method returns an HRESULT success or error code.
            /// </returns>
            /// <remarks>
            ///   <see href="https://learn.microsoft.com/windows/win32/api/d2d1_3/nf-d2d1_3-id2d1devicecontext5-createsvgdocument">Learn more about this API from learn.microsoft.com</see>.
            /// </remarks>
            new void CreateSvgDocument(System.Com.IStream inputXmlStream, D2D_SIZE_F viewportSize, out ID2D1SvgDocument svgDocument);

            /// <summary>
            /// Draws an SVG document.
            /// </summary>
            /// <param name="svgDocument"><para>Type: <b>ID2D1SvgDocument*</b> The SVG document to draw.</para>
            /// <para>
            ///   <see href="https://learn.microsoft.com/windows/win32/api/d2d1_3/nf-d2d1_3-id2d1devicecontext5-drawsvgdocument#parameters">Read more on learn.microsoft.com</see>.</para></param>
            /// <remarks>
            ///   <see href="https://learn.microsoft.com/windows/win32/api/d2d1_3/nf-d2d1_3-id2d1devicecontext5-drawsvgdocument">Learn more about this API from learn.microsoft.com</see>.
            /// </remarks>
            [PreserveSig]
            ...
            /// </summary>
            /// <param name="colorSpace"><para>Type: <b>DXGI_COLOR_SPACE_TYPE</b> The color space to create the color context from.</para>
            /// <para>
            ///   <see href="https://learn.microsoft.com/windows/win32/api/d2d1_3/nf-d2d1_3-id2d1devicecontext5-createcolorcontextfromdxgicolorspace#parameters">Read more on learn.microsoft.com</see>.</para></param>
            /// <param name="colorContext"><para>Type: <b>ID2D1ColorContext1**</b> The created color context.</para>
            /// <para>
            ///   <see href="https://learn.microsoft.com/windows/win32/api/d2d1_3/nf-d2d1_3-id2d1devicecontext5-createcolorcontextfromdxgicolorspace#parameters">Read more on learn.microsoft.com</see>.</para></param>
            /// <returns>
            /// Type: <b><a href="https://learn.microsoft.com/windows/win32/com/structure-of-com-error-codes">HRESULT</a></b> This method returns an HRESULT success or error code.
            /// </returns>
            /// <remarks>
            ///   <see href="https://learn.microsoft.com/windows/win32/api/d2d1_3/nf-d2d1_3-id2d1devicecontext5-createcolorcontextfromdxgicolorspace">Learn more about this API from learn.microsoft.com</see>.
            /// </remarks>
            new void CreateColorContextFromDxgiColorSpace(DXGI_COLOR_SPACE_TYPE colorSpace, out ID2D1ColorContext1 colorContext);

            /// <summary>Creates a color context from a simple color profile. It is only valid to use this with the Color Management Effect in 'Best' mode. (overload 1/2)</summary>
            /// <param name="simpleProfile">
            /// <para>Type: <b>const <a href="https://learn.microsoft.com/windows/desktop/api/d2d1_3/ns-d2d1_3-d2d1_simple_color_profile">D2D1_SIMPLE_COLOR_PROFILE</a>*</b> The simple color profile to create the color context from.</para>
            /// <para><see href="https://learn.microsoft.com/windows/win32/api/d2d1_3/nf-d2d1_3-id2d1devicecontext5-createcolorcontextfromsimplecolorprofile(constd2d1_simple_color_profile_id2d1colorcontext1)#parameters">Read more on docs.microsoft.com</see>.</para>
            /// </param>
            /// <param name="colorContext">
            /// <para>Type: <b>ID2D1ColorContext1**</b> The created color context.</para>
            /// <para><see href="https://learn.microsoft.com/windows/win32/api/d2d1_3/nf-d2d1_3-id2d1devicecontext5-createcolorcontextfromsimplecolorprofile(constd2d1_simple_color_profile_id2d1colorcontext1)#parameters">Read more on docs.microsoft.com</see>.</para>
            /// </param>
            /// <returns>
            /// <para>Type: <b><a href="https://learn.microsoft.com/windows/win32/com/structure-of-com-error-codes">HRESULT</a></b> This method returns an HRESULT success or error code.</para>
            /// </returns>
            /// <remarks>
            /// <para><see href="https://learn.microsoft.com/windows/win32/api/d2d1_3/nf-d2d1_3-id2d1devicecontext5-createcolorcontextfromsimplecolorprofile(constd2d1_simple_color_profile_id2d1colorcontext1)">Learn more about this API from docs.microsoft.com</see>.</para>
            /// </remarks>
            ...
            /// </summary>
            /// <param name="image"><para>Type: <b>ID2D1Image*</b> The image to be drawn to the device context.</para>
            /// <para>
            ///   <see href="https://learn.microsoft.com/windows/win32/api/d2d1_3/nf-d2d1_3-id2d1devicecontext6-blendimage#parameters">Read more on learn.microsoft.com</see>.</para></param>
            /// <param name="blendMode"><para>Type: <b>D2D1_BLEND_MODE</b> The blend mode to be used. See <a href="https://learn.microsoft.com/windows/desktop/Direct2D/blend">Blend modes</a> for more info.</para>
            /// <para>
            ///   <see href="https://learn.microsoft.com/windows/win32/api/d2d1_3/nf-d2d1_3-id2d1devicecontext6-blendimage#parameters">Read more on learn.microsoft.com</see>.</para></param>
            /// <param name="targetOffset"><para>Type: <b>const D2D1_POINT_2F*</b> The offset in the destination space that the image will be rendered to. The entire logical extent of the image will be rendered to the corresponding destination. If not specified, the destination origin will be (0, 0). The top-left corner of the image will be mapped to the target offset. This will not necessarily be the origin. The default value is NULL.</para>
            /// <para>
            ///   <see href="https://learn.microsoft.com/windows/win32/api/d2d1_3/nf-d2d1_3-id2d1devicecontext6-blendimage#parameters">Read more on learn.microsoft.com</see>.</para></param>
            /// <param name="imageRectangle"><para>Type: <b>const D2D1_RECT_F*</b> The corresponding rectangle in the image space will be mapped to the given origins when processing the image. The default value is NULL.</para>
            /// <para>
            ///   <see href="https://learn.microsoft.com/windows/win32/api/d2d1_3/nf-d2d1_3-id2d1devicecontext6-blendimage#parameters">Read more on learn.microsoft.com</see>.</para></param>
            /// <param name="interpolationMode"><para>Type: <b>D2D1_INTERPOLATION_MODE</b> The interpolation mode that will be used to scale the image if necessary. The default value is D2D1_INTERPOLATION_MODE_LINEAR.</para>
            /// <para>
            ///   <see href="https://learn.microsoft.com/windows/win32/api/d2d1_3/nf-d2d1_3-id2d1devicecontext6-blendimage#parameters">Read more on learn.microsoft.com</see>.</para></param>
            /// <remarks>
            ///   <see href="https://learn.microsoft.com/windows/win32/api/d2d1_3/nf-d2d1_3-id2d1devicecontext6-blendimage">Learn more about this API from learn.microsoft.com</see>.
            /// </remarks>
            [PreserveSig]
            unsafe void BlendImage(ID2D1Image image, D2D1_BLEND_MODE blendMode, [Optional] D2D_POINT_2F* targetOffset, [Optional] D2D_RECT_F* imageRectangle, D2D1_INTERPOLATION_MODE interpolationMode);
            #endregion
        }
    }
}
