// <copyright file="ID2D1DCRenderTarget.cs" company="Shkyrockett" >
...
namespace Windows.Win32
{
    namespace Graphics.Direct2D
    {
        ...
        [Guid("1C51BC64-DE61-46FD-9899-63A5D8F03950"), InterfaceType(ComInterfaceType.InterfaceIsIUnknown), ComImport()]
            ...
            : ID2D1Resource, ID2D1RenderTarget
        {
            ...
            /// <para><see href="https://learn.microsoft.com/windows/win32/api/d2d1/nf-d2d1-id2d1dcrendertarget-binddc#parameters">Read more on learn.microsoft.com</see>.</para>
            /// </param>
            /// <param name="pSubRect">
            /// <para>Type: <b>const <a href="https://learn.microsoft.com/windows/win32/api/windef/ns-windef-rect">RECT</a>*</b> The dimensions of the handle to a device context (HDC) to which the render target is bound.</para>
            /// <para><see href="https://learn.microsoft.com/windows/win32/api/d2d1/nf-d2d1-id2d1dcrendertarget-binddc#parameters">Read more on learn.microsoft.com</see>.</para>
            /// </param>
            /// <returns>
            /// <para>Type: <b><a href="https://learn.microsoft.com/windows/win32/com/structure-of-com-error-codes">HRESULT</a></b> If this method succeeds, it returns <b>S_OK</b>. Otherwise, it returns an [**HRESULT**](/windows/desktop/com/structure-of-com-error-codes) error code.</para>
            /// </returns>
            /// <remarks>
            /// <para><see href="https://learn.microsoft.com/windows/win32/api/d2d1/nf-d2d1-id2d1dcrendertarget-binddc">Learn more about this API from learn.microsoft.com</see>.</para>
            /// </remarks>
            unsafe void BindDC(HDC hDC, RECT* pSubRect);
            #endregion
        }
    }
}
