...
namespace Windows.Win32
{
    namespace Graphics.Direct2D
    {
            ...
            : ID2D1Resource, ID2D1RenderTarget, ID2D1DeviceContext, ID2D1DeviceContext1
        {
            ...
            /// </remarks>
            void CreateLookupTable3D(D2D1_BUFFER_PRECISION precision, [MarshalAs(UnmanagedType.LPArray, SizeConst = 3)] uint[] extents, [MarshalAs(UnmanagedType.LPArray, SizeParamIndex = 3)] byte[] data, uint dataCount, [MarshalAs(UnmanagedType.LPArray, SizeConst = 2)] uint[] strides, out ID2D1LookupTable3D lookupTable);
            ...
            /// </remarks>
            void CreateImageSourceFromDxgi([MarshalAs(UnmanagedType.LPArray, SizeParamIndex = 1)] IDXGISurface[] surfaces, uint surfaceCount, DXGI_COLOR_SPACE_TYPE colorSpace, D2D1_IMAGE_SOURCE_FROM_DXGI_OPTIONS options, out ID2D1ImageSource imageSource);
